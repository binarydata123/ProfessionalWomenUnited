...
export async function generateMetadata(): Promise<Metadata> {
	return {
		title: 'Divorce Lawyer in Abu Dhab – Connect Legal',
		description:
			'Need legal assistance with your divorce proceedings? Find the best divorce lawyer in Abu Dhabi through Connect Legal and secure the best outcome for your case..',
		alternates: {
