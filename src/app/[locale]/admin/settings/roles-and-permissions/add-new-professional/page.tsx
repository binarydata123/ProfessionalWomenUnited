...
import { getAllCountries, getAllJurisdictions, getAllServices } from '../../../../../../../lib/frontendapi';
import { getAllSpecialization, createLawyerByAdmin, getAllFirms } from '../../../../../../../lib/adminapi';
						...
						<div className="col-lg-12 col-xl-8">
							<div className="profile-picture">
								...
								<div className="form-grou mt-3 position-relative">
									...
									<span
										className={`eye-icon position-absolute fafa_eye position-set ${showPassword ? 'show' : ''
											}`}
					...
					<div className="row">
						<div className="col-md-6 col-lg-12 col-xl-6">
							<div className="profile-picture">
								...
								<h5 className="font-x-large22 weight-bold green-dark mt-4 pb-3" id="rates">
									Upgrade Account &nbsp;{' '}
								</h5>
								<select
									className="form-fild  w-100"
