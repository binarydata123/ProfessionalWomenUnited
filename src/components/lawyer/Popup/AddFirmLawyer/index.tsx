...
import { getAllSpecialization } from '../../../../../lib/lawyerapi';
...
export default function AddFirmLawyer({ firmDetails, onCancel, firmId, firmdata, latestId }: AddFirmProps) {
    ...
    function handleSubmit(event: React.FormEvent<HTMLFormElement>) {
        ...
        if (isValid) {
            ...
            const firmExists = firmDetails.some((firm: FormData) => firm.firm_name === formData.firm_name);
            if (firmExists) {
                toast.error('This firm already exists. Please create with another firm name.');
                setIsLoading(false);
                return;
            }
    ...
    useEffect(() => {
        if (firmDetails && firmDetails.length > 0) {
            ...
            if (matchedFirm) {
                ...
                const imageUrl = process.env.NEXT_PUBLIC_IMAGE_URL + '/images/firm/' + matchedFirm.image;
                ...
                <div className="row mb-3 align-items-center">
                    ...
                    <div className="col-sm-10 col-9">
                        <div className="file-btn-upload  d-md-flex">
                            ...
                            {/* <button className="bg-893168 weight-semi-bold font-small">
                                <img
