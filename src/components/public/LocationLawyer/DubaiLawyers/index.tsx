...
export default function DubaiLawyers({ onclose }: any) {
						...
						<div className="tab-pane fade show active" role="tabpanel">
							<ul className="list-mega">
								<div>
									...
									<li>
										<Link
											href={`${locale !== 'en' ? `/${locale}` : ''}/crypto-lawyer-dubai`}
											onClick={onclose} className={`set-color-sub-menus ${activeLink === 'crypto' ? 'active-link-mega-menu' : ''}`}
