...
export const metadata: Metadata = {
	title: 'Complete Your Lawyer Profile - Connect Legal',
	description: 'Provide additional information to complete your lawyer profile on Connect Legal and connect with clients.',
	alternates: {
