...
export const metadata: Metadata = {
	title: 'Choose Your Profile - Connect Legal',
	description: 'Select your role on Connect Legal to either expand your reach as a lawyer or get legal advice as an user.',
	alternates: {
