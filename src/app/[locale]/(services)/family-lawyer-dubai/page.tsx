...
export async function generateMetadata(): Promise<Metadata> {
	return {
		title: 'Family Lawyer in Dubai – Connect Legal',
		description:
			'Protect your family\'s future with the help of a family lawyer in Dubai.Connect Legal can assist you in navigating complex family law matters.',
		alternates: {
