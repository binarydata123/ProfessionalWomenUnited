...
export const metadata: Metadata = {
	title: 'Create Your Profile - Connect Legal',
	description: 'Create your profile on Connect Legal to either expand your reach as a lawyer or get legal advice as a user.',
	alternates: {
