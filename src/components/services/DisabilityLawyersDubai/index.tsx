...
export default function DisabilityLawyersDubai() {
	const t = useTranslations('disabilityLawyer');
					...
					<div className="row">
						<div className="col-lg-7">
							<h1 className="font-larger weight-bold green-medium-dark mobile-m-0">
								{t('Disability_Lawyers_in_Dubai')}
							</h1>
							<p className="weight-light social-link font-medium mt-4">
								{isMobileView ? (
									<>
										{showFullText ? (
											<>{t('A_disability_lawyer_advocates')}</>
										) : (
											`${t('A_disability_lawyer_advocates')}`
										)}
										<br />
						...
						<div className="col-lg-5 text-right tab-center">
							<Image
								src="/images/legal-service/DisabiltyLawyer.jpg"
								alt="AdobeStock"
					...
					<div className="row mt-md-5 align-items-end">
						<div className="col-lg-4 col-md-12">
							<h2 className="font-smaller weight-bold text-white">
								<span className="green-med">{t('Disability_in_the')}</span>{' '}
								<span className="green-med-col">{t('UAE_Statistics')}</span>
							</h2>
							...
							<div className="row align-items-lg-center set-pad-stat set-mob-pad">
								...
								<div className="col-lg-11 col-9 p-lg-0">
									<p
										...
										{t('percent_of_these_individuals')}
									</p>
								</div>
							</div>
											...
											<div className="accordion-item">
												<h2 className="accordion-header" id="headingOne">
													<button
														...
														{t('Legislation_Supporting_People_with_Disabilities')}
													</button>
												</h2>
												<div
													id="collapseOne"
													...
													<div className="accordion-body border-0 text-white">
														{t('Legislation_such_as_Federal_Law_No')}
														<br />
														{t('Moreover_Resolution_No')}
													</div>
												</div>
											</div>
											<div className="accordion-item">
												<h2 className="accordion-header" id="headingTwo1">
													<button
														...
														{t('Employer_Legal_Requirements_for_Inclusion')}
													</button>
												</h2>
												<div
													id="collapseTwo1"
											...
											<div className="accordion-item">
												<h2 className="accordion-header" id="headingThree">
													<button
														...
														{t('Accessibility_Measures_in_the_Workplace')}
													</button>
												</h2>
												<div
													id="collapseThree"
					...
					<div className="row sectionGap flex-wrap-none">
						<div className="col-lg-12 col-xl-5 col-md-12">
							<h2 className="font-smaller text-black  weight-bold mb-4">
								{t('Understanding')} <span className="green-medium-2">{t('Disability_Rights')}</span>
							</h2>
							<Image
							...
							<div className="accordion mt-5 margin-top-1" id="accordionExample">
								<div className="accordion-item">
									...
									<div
										...
										aria-labelledby="headingOne"
										data-bs-parent="#accordionExample">
										<div className="accordion-body border-0">{t('Disabled_individuals_have')}</div>
									</div>
								</div>
								<div className="accordion-item">
									...
									<div
										...
										data-bs-parent="#accordionExample">
										<div className="accordion-body border-0">{t('Every_person_regardless')}</div>
									</div>
								</div>
								<div className="accordion-item">
									<h2 className="accordion-header" id="headingThree">
									...
									<div
										...
										<div className="accordion-body border-0">
											{t('Disabled_individuals_can_pursue')}
										</div>
									</div>
								</div>
								<div className="accordion-item">
									...
									<div
										...
										data-bs-parent="#accordionExample">
										<div className="accordion-body border-0">
											{t('Access_to_quality_healthcare')}
										</div>
									</div>
								</div>
								<div className="accordion-item">
									...
									<div
										...
										data-bs-parent="#accordionExample">
										<div className="accordion-body border-0">
											{t('Disabled_individuals_have_the')}
										</div>
									</div>
								</div>
								<div className="accordion-item">
									...
									<div
										...
										data-bs-parent="#accordionExample">
										<div className="accordion-body border-0">
											{t('Disabled_individuals_have_the_rght')}
										</div>
									</div>
								</div>
							</div>
								...
								<div className="accordion mt-4" id="setbotomspace">
									...
									<div className="accordion-item">
										...
										<div
											...
											data-bs-parent="#accordionExample">
											<div className="accordion-body border-0">
												{t('Clients_benefit_from_personalized')}
											</div>
										</div>
									</div>
									<div className="accordion-item">
										<h2 className="accordion-header" id="headingTen">
											<button
												...
												{t('Timely_and_Efficient_Legal_Services')}
											</button>
										</h2>
										<div
											id="collapseTen"
											...
											data-bs-parent="#accordionExample">
											<div className="accordion-body border-0">
												{t('Lawyers_on_our_platform_prioritize')}
											</div>
										</div>
									</div>
									<div className="accordion-item">
										...
										<div
											...
											data-bs-parent="#accordionExample">
											<div className="accordion-body border-0">
												{t('Connect_Legal_boasts_a_track')}
											</div>
										</div>
									</div>
									<div className="accordion-item">
									...
									<div className="accordion-item">
										<h2 className="accordion-header" id="headingThirteen">
											<button
												...
												{t('Compassionate_Client_Advocacy')}
											</button>
										</h2>
										<div
											id="collapseThirteen"
				...
				<div className="container">
					<div className="still">
						...
						<h3 className="font-xxx-large weight-bold text-black mt-3 discover-font">
							{t('Discover_the')}{' '}
							<span className="green-medium-2">{t('Top_Disability_Lawyers_in_Dubai')}</span>
						</h3>
			...
			<section id="legal-issues" className="legal-issues mobile-bg-color  mt-5 mb-5">
				<div className="container text-center">
					...
					<h3 className="font-smaller weight-bold social-link">
						...
						<span>{t('What_Do_Clients_Most_Frequently_Search_For')}</span>
					</h3>
					<p className="font-medium weight-medium social-link set-text-padding color-frequent set-top-mrgin-mbl">
						{t('Clients_often_seek_expert_legal')}
						<br />
						{t('Select_the_legal_issue_your_facing')}
					</p>
					<ul className="pt-3 class-add">
						<li>
							<Link href="#">{t('Disability_benefits_eligibility')}</Link>
						</li>
						<li>
							<Link href="#">{t('Workplace_accommodations')}</Link>
						</li>
						<li>
							<Link href="#">{t('Disability_discrimination')}</Link>
						</li>
						<li>
							<Link href="#">{t('Social_Security_Disability_Insurance_SSDI_claims')}</Link>
						</li>
						<li>
							<Link href="#">{t('Accessibility_rights')}</Link>
						</li>
						<li>
							<Link href="#">{t('Special_education_accommodations')}</Link>
						</li>
					</ul>
				</div>
			</section>
						...
						<div className="col-lg-7 needlawyer-text-motor">
							<div className="titleHow">
								...
								<h2 className="text-black-add-fig Discover-lawyer discover-text-fun">
									...
									<span className="green-medium-2"> {t('Disability')}</span>-
							...
							<div className="row mt-5 benefit-margin" style={{marginBottom: '65px'}}>
								...
								<div className="col-lg-12">
									<div className="titleHow pt-lg-0">
										...
										<div className="text-start Discover-lawyer" />
										{t('Disability_lawyers_represent')}
									</div>
								</div>
								<div className="col-lg-12">
									<div className="titleHow pt-lg-0">
										...
										<div className="text-start Discover-lawyer" />
										{t('Disability_lawyers_advocate_for')}
									</div>
								</div>
							</div>
						</div>
							...
							<div className="col-lg-12 col-xl-7 col-md-12">
								<div className="gotTitle">
									...
									<h2 className="font-smaller  weight-bold mb-4">
										...
										<span>{t('Disability_Lawyer_FAQ')}</span>
									</h2>
								</div>
										...
										<div className="accordion-item">
											<h2 className="accordion-header" id="headingOne">
												<button
													...
													aria-expanded="true"
													aria-controls="collapseOne">
													{t('How_can_a_disability_lawyer_help_me')}
												</button>
											</h2>
											<div
												id="collapseOne"
												...
												data-bs-parent="#accordionExample">
												<div className="accordion-body border-0 text-white">
													{t('A_disability_lawyer_can_assist')}
												</div>
											</div>
										</div>
										<div className="accordion-item">
											<h2 className="accordion-header" id="headingTwo1">
												<button
													...
													aria-expanded="true"
													aria-controls="collapseTwo1">
													{t('What_types_of_disability_benefits_can_I_apply_for')}
												</button>
											</h2>
											<div
												id="collapseTwo1"
										...
										<div className="accordion-item">
											<h2 className="accordion-header" id="headingThree">
												<button
													...
													aria-expanded="true"
													aria-controls="collapseThree">
													{t('What_should_I_do_if_my_disability_benefits_are_denied')}
												</button>
											</h2>
											<div
												id="collapseThree"
										...
										<div className="accordion-item">
											<h2 className="accordion-header" id="headingFour">
												<button
													...
													aria-expanded="true"
													aria-controls="collapseFour">
													{t('What_accommodations_am_I_entitled_to_in_the_workplace')}
												</button>
											</h2>
											<div
												id="collapseFour"
										...
										<div className="accordion-item">
											<h2 className="accordion-header" id="headingFour">
												<button
													...
													aria-expanded="true"
													aria-controls="collapseFive">
													{t('How_can_I_file_a_disability_discrimination_complaint')}
												</button>
											</h2>
											<div
												id="collapseFive"
												...
												data-bs-parent="#accordionExample">
												<div className="accordion-body border-0 text-white">
													{t('If_you_believe_you_experienced')}
												</div>
											</div>
										</div>
									</div>
