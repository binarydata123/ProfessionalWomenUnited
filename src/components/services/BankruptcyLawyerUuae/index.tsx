...
export default function InsolvencyLawyer() {
	...
	const t = useTranslations('bankruptcyLawyer');
				...
				<div className="container">
					...
					<div className="row">
						...
						<div className="col-lg-5 text-right tab-center">
							<Image
								src="/images/legal-service/bankruptcy_lawyer.jpeg"
								alt="AdobeStock"
					...
					<div className="row mt-md-5 align-items-end">
						<div className="col-lg-12 col-xl-12 col-md-12">
							<h2 className="font-smaller weight-bold text-white">
								<span className="green-med">{t('Bankruptcy_Trends')} </span>{' '}
								<span className="green-med-col">{t('In_the_UAE')} </span>
							</h2>
							<div className="accordion-body border-0 text-white">
								{t('The_Landscape_of_Bankruptcy')}
										...
										<div className="accordion mt-5" id="accordionExample">
											<div className="accordion-item">
												...
												<div
													...
													<div className="accordion-body border-0 text-white">
														{t('In_Recent_Years_the_UAE')}
														<br />
														<br /> {t('Companies_Facing_Financial')}
													</div>
												</div>
											</div>
											...
											<div className="accordion-item">
												...
												<div
													...
													data-bs-parent="#accordionExample">
													<div className="accordion-body border-0 text-white">
														{t('The_Recent_Amendments')} <br />
														<br />
														{t('By_Clarifying_Situations')}
													</div>
												</div>
											</div>
											...
											<div className="accordion-item">
												...
												<div
													...
													data-bs-parent="#accordionExample">
													<div className="accordion-body border-0 text-white">
														{t('Dealing_with_Bankruptcy')}
														<br />
														<br />
														{t('Furthermore')}
														<br />
														<br /> {t('If_You_Need_a_Bankruptcy')}
													</div>
												</div>
											</div>
										</div>
					...
					<div className="row sectionGap flex-wrap-none">
						<div className="col-lg-12 col-xl-5 col-md-12">
							<h2 className="font-smaller text-black  weight-bold mb-4">
								{t('Common_Reasons')} <span className="green-medium-2"> {t('For_Bankruptcy')}</span>
							</h2>
							<Image
							...
							<div className="accordion mt-5 margin-top-1" id="accordionExample">
								<div className="accordion-item">
									...
									<div
										...
										<div className="accordion-body border-0">
											{t('Economic_Downturns_Like')}
											<ul className="custom-bullets mt-3 mb-3">
												<li>{t('Global_Economic_Trends')}</li>
												<li>{t('Geopolitical_Instability')}</li>
												<li>{t('Regulatory_Changes')}</li>
											</ul>
										</div>
									</div>
								</div>
								<div className="accordion-item">
									...
									<div
										...
										data-bs-parent="#accordionExample">
										<div className="accordion-body border-0">
											{t('Accumulating_Excessive')}
											<br />
											{t('High_Interest_Rates')}
										</div>
									</div>
								</div>
								<div className="accordion-item">
								...
								<div className="accordion-item">
									...
									<div
										...
										aria-labelledby="headingThree"
										data-bs-parent="#accordionExample">
										<div className="accordion-body border-0">{t('Non_Compliance_with_Legal')}</div>
									</div>
								</div>
								<div className="accordion-item">
									<h2 className="accordion-header" id="headingFive">
										<button
											...
											{t('Market_Disruptions_and_Technological_Changes')}
										</button>
									</h2>
									<div
										id="collapseFive"
										...
										data-bs-parent="#accordionExample">
										<div className="accordion-body border-0">{t('Changes_in_the_Market')}</div>
									</div>
								</div>
								<div className="accordion-item">
									...
									<div
										...
										data-bs-parent="#accordionExample">
										<div className="accordion-body border-0">
											{t('External_Factors_Beyond')} <br />
											{t('Similarly_Unexpected')}
										</div>
									</div>
								</div>
							</div>
									...
									<div className="accordion-item">
										<h2 className="accordion-header" id="headingEight">
											<button
												...
												{t('Specialized_Expertise_in_Bankruptcy')}
											</button>
										</h2>
										<div
											id="collapseEight"
									...
									<div className="accordion-item">
										<h2 className="accordion-header" id="headingNine">
											<button
												...
												{t('Proven_Track_Record_in_Bankruptcy_Proceedings')}
											</button>
										</h2>
										<div
											id="collapseNine"
									...
									<div className="accordion-item">
										<h2 className="accordion-header" id="headingTen">
											<button
												...
												{t('Strategic_Counsel_for_Debt_Relief')}
											</button>
										</h2>
										<div
											id="collapseTen"
											...
											data-bs-parent="#accordionExample">
											<div className="accordion-body border-0">
												{t('Connect_Legals_Bankruptcy_Insolvency')}
											</div>
										</div>
									</div>
									<div className="accordion-item">
										<h2 className="accordion-header" id="headingEleven">
											<button
												...
												{t('Comprehensive_Representation_for_Creditors_and_Debtors')}{' '}
											</button>
										</h2>
										<div
											id="collapseEleven"
											...
											data-bs-parent="#accordionExample">
											<div className="accordion-body border-0">
												{t('We_Provide_Comprehensive_Representation')}
											</div>
										</div>
									</div>
									<div className="accordion-item">
									...
									<div className="accordion-item">
										<h2 className="accordion-header" id="headingThirteen">
											<button
												...
												type="button"
												data-bs-toggle="collapse"
												data-bs-target="#headingThirteen"
												aria-expanded="false"
												aria-controls="headingThirteen">
												{t('Commitment_to_Integrity_and_Ethical_Practice')}
											</button>
										</h2>
										<div
											id="headingThirteen"
											...
											data-bs-parent="#accordionExample">
											<div className="accordion-body border-0">
												{t('Connect_Legal_is_Committed_to')}
											</div>
										</div>
									</div>
									{/* <div className="accordion-item">
										...
										<div
											...
											data-bs-parent="#accordionExample">
											<div className="accordion-body border-0">{t('')}</div>
										</div>
									</div> */}
								</div>
								<div className="about-btn-two mt-lg-5 mt-3">
				...
				<div className="container">
					<div className="still">
						...
						<h3 className="font-xxx-large weight-bold text-black mt-3 discover-font">
							{t('Discover_the')}{' '}
							<span className="green-medium-2">{t('Top_Bankruptcy_Lawyers_in_Dubai')}</span>
						</h3>
						<p className="font-medium weight-light text-black-add-fig mt-3">
			...
			<section id="legal-issues" className="legal-issues   mobile-bg-color mt-5 mb-5">
				<div className="container text-center">
					...
					<ul className="pt-3 class-add">
						<li>
							<Link href="#">{t('Filing_for_Bankruptcy')}</Link>
						</li>
						<li>
							<Link href="#">{t('Debt_Restructuring_and_Repayment_Plans')}</Link>
						</li>
						<li>
							<Link href="#">{t('Asset_Protection_Strategies')}</Link>
						</li>
						<li>
							<Link href="#">{t('Creditors_Rights_in_Bankruptcy_Proceedings')}</Link>
						</li>
						<li>
							<Link href="#">{t('Bankruptcy_Litigation_and_Disputes')}</Link>
						</li>
					</ul>
				</div>
			</section>
						...
						<div className="col-lg-7 needlawyer-text-motor">
							<div className="titleHow">
								...
								<h2 className="text-black-add-fig Discover-lawyer discover-text-fun">
									...
									<span className="green-medium-2"> {t('Bankruptcy')}</span>
							...
							<div className="row mt-5 benefit-margin" style={{marginBottom: '65px'}}>
								<div className="col-lg-12">
									<div className="titleHow pt-lg-0">
										...
										{t('Bankruptcy_Lawyers_Provide_Comprehensive')}
									</div>
								</div>
								<div className="col-lg-12">
									<div className="titleHow pt-lg-0">
										...
										<div className="text-start Discover-lawyer" />
										{t('Bankruptcy_Lawyers_Assist_Clients_in_Debt')}
									</div>
								</div>
								<div className="col-lg-12">
									<div className="titleHow pt-lg-0">
										...
										<div className="text-start Discover-lawyer" />
										{t('In_Bankruptcy_Litigation_or_Creditor')}
									</div>
								</div>
								<div className="col-lg-12">
									<div className="titleHow pt-lg-0">
										...
										<div className="text-start Discover-lawyer" />
										{t('Bankruptcy_Lawyers_Assist_Clients')}
									</div>
								</div>
							</div>
						</div>
										...
										<div className="accordion-item">
											<h2 className="accordion-header" id="headingOne">
												<button
													...
													aria-expanded="true"
													aria-controls="collapseOne">
													{t('Who_is_a_Bankruptcy_Lawyer_and_Do_I_Need_One')}
												</button>
											</h2>
											<div
												id="collapseOne"
												...
												data-bs-parent="#accordionExample">
												<div className="accordion-body border-0 text-white">
													{t('A_Bankruptcy_Lawyer_is_a_Legal_Professional')}
												</div>
											</div>
										</div>
										<div className="accordion-item">
											<h2 className="accordion-header" id="headingTwo1">
												<button
													...
													{t('What_Services_Does_a_Bankruptcy_Lawyer_Provide')}
												</button>
											</h2>
											<div
												id="collapseTwo1"
												...
												data-bs-parent="#accordionExample">
												<div className="accordion-body border-0 text-white">
													{t('Bankruptcy_Lawyers_Offer_Various_Services')}
												</div>
											</div>
										</div>
										<div className="accordion-item">
											<h2 className="accordion-header" id="headingThree">
												<button
													...
													aria-expanded="true"
													aria-controls="collapseThree">
													{t('How_Can_a_Bankruptcy_Lawyer_in_the_UAE_Help_Me')}
												</button>
											</h2>
											<div
												id="collapseThree"
												...
												data-bs-parent="#accordionExample">
												<div className="accordion-body border-0 text-white">
													{t('A_Bankruptcy_Lawyer_in_the_UAE_Can_Provide')}
												</div>
											</div>
										</div>
										<div className="accordion-item">
											<h2 className="accordion-header" id="headingFour">
												<button
													...
													aria-expanded="true"
													aria-controls="collapseFour">
													{t('What_Should_I_Look_for_When_Hiring_a_Bankruptcy_Lawyer')}
												</button>
											</h2>
											<div
												id="collapseFour"
												...
												data-bs-parent="#accordionExample">
												<div className="accordion-body border-0 text-white">
													{t('When_Hiring_a_Bankruptcy_Lawyer_Account')}
												</div>
											</div>
										</div>
										<div className="accordion-item">
											<h2 className="accordion-header" id="headingFive">
												<button
													...
													aria-controls="collapseFive">
													{t(
														'Can_a_Bankruptcy_Lawyer_Assist_with_Debt_Relief_Outside_of_Bankruptcy'
													)}
												</button>
											</h2>
											<div
												...
												data-bs-parent="#accordionExample">
												<div className="accordion-body border-0 text-white">
													{t('Yes_a_Bankruptcy_Lawyer_Can_Explore_Alternatives')}
												</div>
											</div>
										</div>
										<div className="accordion-item">
											<h2 className="accordion-header" id="headingSix">
												<button
													...
													aria-expanded="true"
													aria-controls="collapseSix">
													{t('What_are_the_Benefits_of_Hiring_a_Bankruptcy_Lawyer')}
												</button>
											</h2>
											<div
												id="collapseSix"
												...
												data-bs-parent="#accordionExample">
												<div className="accordion-body border-0 text-white">
													{t('Hiring_a_Bankruptcy_Lawyer_Can_Provide')}
												</div>
											</div>
										</div>
									</div>
