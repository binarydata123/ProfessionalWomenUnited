...
export default function CivilLawyer() {
	const c = useTranslations('civilLawyer');
					...
					<div className="legaltopic single-question-page">
						<section>
							<div id="legal-serve">
								...
								<span style={{ color: 'rgba(196,144,115)' }}>{c('Find_a_Lawyer')}</span>
							</div>
						</section>
					</div>
					<div className="row">
							...
							<p className="weight-light social-link font-medium mt-4">
								{isMobileView ? (
									<>
										{showFullText ? (
											<>
												{c('A_civil_lawyer_resolves_disputes')}
												<br />
												{c('They_work_closely_with')}
											</>
										) : (
											`${c('They_work_closely_with')}`
										)}
						...
						<div className="col-lg-5 text-right tab-center">
							<Image
								src="/images/legal-service/civil_lawyer.jpeg"
								alt="AdobeStock"
					...
					<div className="row mt-md-5 align-items-end">
						<div className="col-lg-12 col-xl-12 col-md-12">
							<h2 className="font-smaller weight-bold text-white">
								<span className="green-med">{c('Overview_of_the')}</span>{' '}
								<span className="green-med-col">{c('Civil_Law')}</span>
							</h2>
							<div className="accordion-body border-0 text-white">
								{c('The_civil_law_system_or_the_continental')}
								<ul className="custom-bullets mt-3 mb-3">
									<li>{c('Comprehensive_system')}</li>
									<li>{c('Favoring_cooperation_and_order')}</li>
									<li>{c('Salient_features')}</li>
								</ul>
								{c('Other_than_the_UAE')}
							</div>
						</div>
						<div className="container">
							<div className="row">
											...
											<div className="accordion-item">
												<h2 className="accordion-header" id="headingOne">
													<button
														...
														{c('Dual_Legal_System_in_the_UAE')}
													</button>
												</h2>
												<div
													id="collapseOne"
													...
													<div className="accordion-body border-0 text-white">
														{c('The_UAE_has_a_dual_legal_system')}
													</div>
												</div>
											</div>
											<div className="accordion-item">
												<h2 className="accordion-header" id="headingTwo1">
													<button
														...
														{c('Foundation_and_Influence_of_Sharia_Laws')}
													</button>
												</h2>
												<div
													id="collapseTwo1"
													...
													data-bs-parent="#accordionExample">
													<div className="accordion-body border-0 text-white">
														{c('Sharia_law_serves_as_one_of_the')}
														<br />
														{c('Sharia_courts_in_the_UAE_have')}
													</div>
												</div>
											</div>
											<div className="accordion-item">
												...
												<div
													...
													data-bs-parent="#accordionExample">
													<div className="accordion-body border-0 text-white">
														{c('The_UAE_has_a_dual')}
														<br />
														{c('This_approach_differs_from')}
														<br />
														{c('If_you_need_assistance')}
													</div>
												</div>
											</div>
										</div>
					...
					<div className="row sectionGap flex-wrap-none">
						<div className="col-lg-12 col-xl-5 col-md-12">
							<h2 className="font-smaller text-black  weight-bold mb-4">
								{c('Navigating_Legal_Challenges')}{' '}
								<span className="green-medium-2">{c('Common_Civil_Law_Issues')}</span>
							</h2>
							<Image
							...
							<div className="accordion mt-5 margin-top-1" id="accordionExample">
								<div className="accordion-item">
									...
									<div
										...
										<div className="accordion-body border-0">
											{c('Contract_disputes_normally_occur')}
										</div>
									</div>
								</div>
								<div className="accordion-item">
									<h2 className="accordion-header" id="headingTwo">
										<button
											...
											{c('Property_Ownership_Conflicts')}
										</button>
									</h2>
									<div
										id="collapseTwo"
								...
								<div className="accordion-item">
									...
									<div
										...
										data-bs-parent="#accordionExample">
										<div className="accordion-body border-0">
											{c('Employment_disagreements_can')}
										</div>
									</div>
								</div>
								<div className="accordion-item">
									...
									<div
										...
										data-bs-parent="#accordionExample">
										<div className="accordion-body border-0">
											{c('Personal_injury_claims_involve_seeking')}
										</div>
									</div>
								</div>
								<div className="accordion-item">
									...
									<div
										...
										data-bs-parent="#accordionExample">
										<div className="accordion-body border-0">
											{c('Family_law_disputes_encompass')}
										</div>
									</div>
								</div>
								<div className="accordion-item">
									<h2 className="accordion-header" id="headingSix">
										<button
											...
											{c('Consumer_Protection_Complaints')}
										</button>
									</h2>
									<div
										id="collapseSix"
										...
										data-bs-parent="#accordionExample">
										<div className="accordion-body border-0">
											{c('Consumer_protection_complaints_arise')}
										</div>
									</div>
								</div>
							</div>
						...
						<div className="col-lg-7 text-right order-lg-0 order-last">
							<div className="still" id="accordianSectionGreen">
								<h3 className="font-smaller weight-bold text-black-add-fig">
									{c('Why_Should_I_Hire_a')} <br />{' '}
									<span className="green-medium-2">
										{c('Civil_Lawyer')}
										<br />{' '}
									</span>{' '}
									{c('from_Connect_Legal')}
								</h3>
									...
									<div className="accordion-item">
										<h2 className="accordion-header" id="headingEight">
											<button
												...
												{c('In_depth_knowledge_of_Civil_Law_in_UAE')}
											</button>
										</h2>
										<div
											id="collapseEight"
											...
											data-bs-parent="#accordionExample">
											<div className="accordion-body border-0">
												{c('Connect_Legals_civil_lawyers_thoroughly')}
											</div>
										</div>
									</div>
									<div className="accordion-item">
										<h2 className="accordion-header" id="headingNine">
											<button
												...
												{c('Proven_Track_Record_in_Successful_Cases')}
											</button>
										</h2>
										<div
											id="collapseNine"
											...
											data-bs-parent="#accordionExample">
											<div className="accordion-body border-0">
												{c('Our_civil_litigation_lawyers_have_successfully')}
											</div>
										</div>
									</div>
									<div className="accordion-item">
										<h2 className="accordion-header" id="headingTen">
											<button
												...
												{c('Strategic_Approach_to_Legal_Issues')}
											</button>
										</h2>
										<div
											id="collapseTen"
											...
											data-bs-parent="#accordionExample">
											<div className="accordion-body border-0">
												{c('At_Connect_Legal_our_civil_lawyers')}
											</div>
										</div>
									</div>
									<div className="accordion-item">
										<h2 className="accordion-header" id="headingEleven">
											<button
												...
												{c('Excellent_Client_Communication')}
											</button>
										</h2>
										<div
											id="collapseEleven"
											...
											data-bs-parent="#accordionExample">
											<div className="accordion-body border-0">
												{c('Connect_Legals_civil_lawyers_prioritize')}
											</div>
										</div>
									</div>
									<div className="accordion-item">
										<h2 className="accordion-header" id="headingTweleve">
											<button
												...
												{c('Comprehensive_Legal_Services')}
											</button>
										</h2>
										<div
											id="collapseTweleve"
											...
											data-bs-parent="#accordionExample">
											<div className="accordion-body border-0">
												{c('Our_civil_lawyers_offer_a_comprehensive')}
											</div>
										</div>
									</div>
									<div className="accordion-item">
										<h2 className="accordion-header" id="headingThirteen">
											<button
												...
												{c('Personalized_Legal_Representation')}
											</button>
										</h2>
										<div
											id="collapseThirteen"
											...
											data-bs-parent="#accordionExample">
											<div className="accordion-body border-0">
												{c('Connect_Legals_civil_lawyers_understand')}
											</div>
										</div>
									</div>
								</div>
			...
			<section id="legal-issues" className="legal-issues mobile-bg-color  mt-5 mb-5">
				<div className="container text-center">
					...
					<h3 className="font-smaller weight-bold social-link">
						...
						<span className="green-medium-2">
							{' '}
							{c('Most_Frequently')} <br /> {c('Search_For')}
						</span>
					</h3>
					<p className="font-medium weight-medium social-link set-text-padding color-frequent set-top-mrgin-mbl">
						{c('Individuals_looking_for_legal')}
						<br />
						{c('Select_the_legal_issue_your_facing_and_connect_with_a_legal_expert')}
					</p>
					<ul className="pt-3 class-add">
						<li>
							<Link href="#">{c('Contract_disputes_and_drafting')}</Link>
						</li>
						<li>
							<Link href="#">{c('Real_estate_transactions_and_disputes')}</Link>
						</li>
						<li>
							<Link href="#">{c('Family_law_issues_including_divorce_and_child_custody')}</Link>
						</li>
						<li>
							<Link href="#">{c('Employment_and_labor_law_matters')}</Link>
						</li>
						<li>
							<Link href="#">{c('Property_disputes_and_ownership_issues')}</Link>
						</li>
						<li>
							<Link href="#">{c('Personal_injury_claims_and_compensation')}</Link>
						</li>
					</ul>
				</div>
			</section>
						...
						<div className="col-lg-7 needlawyer-text-motor">
							<div className="titleHow">
								...
								<h2 className="text-black-add-fig Discover-lawyer discover-text-fun">
									{c('How_Lawyers_Can_Assist_in')}
									<span className="green-medium-2"> {c('Civil__Law')}</span>{' '}
									{c('Related_Legal_Matters')}
								</h2>
								<div className="mt-4">
									<Link href={'/find-a-professional'}>
							...
							<div className="row mt-5 benefit-margin" style={{ marginBottom: '65px' }}>
								<div className="col-lg-12">
									<div className="titleHow pt-lg-0">
										...
										{c('Civil_lawyers_can_provide_valuable')}
									</div>
								</div>
								<div className="col-lg-12">
									<div className="titleHow pt-lg-0">
										...
										<div className="text-start Discover-lawyer" />
										{c('Civil_law_involves_a_lot_of_documentation')}
									</div>
								</div>
								<div className="col-lg-12">
									<div className="titleHow pt-lg-0">
										...
										<div className="text-start Discover-lawyer" />
										{c('When_disputes_cannot_be_resolved')}
									</div>
								</div>
								<div className="col-lg-12">
									<div className="titleHow pt-lg-0">
										...
										<div className="text-start Discover-lawyer" />
										{c('Civil_attorneys_play_a_crucial')}
									</div>
								</div>
							</div>
						</div>
										...
										<div className="accordion-item">
											<h2 className="accordion-header" id="headingTwo1">
												<button
													...
													aria-expanded="true"
													aria-controls="collapseTwo1">
													{c('How_does_Connect_Legal_assist_with_civil_law_matters')}
												</button>
											</h2>
											<div
												id="collapseTwo1"
												...
												data-bs-parent="#accordionExample">
												<div className="accordion-body border-0 text-white">
													{c('Connect_Legal_provides_expert')}
												</div>
											</div>
										</div>
										<div className="accordion-item">
											<h2 className="accordion-header" id="headingThree">
												<button
													...
													aria-expanded="true"
													aria-controls="collapseThree">
													{c('Do_I_need_a_civil_lawyer_for_contract_disputes')}
												</button>
											</h2>
											<div
												id="collapseThree"
												...
												data-bs-parent="#accordionExample">
												<div className="accordion-body border-0 text-white">
													{c('Yes_hiring_a_civil_lawyer_in_Dubai')}
												</div>
											</div>
										</div>
										<div className="accordion-item">
											<h2 className="accordion-header" id="headingFour">
												<button
													...
													aria-expanded="true"
													aria-controls="collapseFour">
													{c('How_can_I_find_the_right_civil_lawyer_for_my_case')}
												</button>
											</h2>
											<div
												id="collapseFour"
												...
												data-bs-parent="#accordionExample">
												<div className="accordion-body border-0 text-white">
													{c('You_can_find_the_right_civil_lawyer')}
												</div>
											</div>
										</div>
										<div className="accordion-item">
											<h2 className="accordion-header" id="headingFive">
												<button
													...
													aria-expanded="true"
													aria-controls="collapseFive">
													{c('What_should_I_bring_to_my_first_meeting_with_a_civil_lawyer')}
												</button>
											</h2>
											<div
												id="collapseFive"
												...
												data-bs-parent="#accordionExample">
												<div className="accordion-body border-0 text-white">
													{c('Bring_any_relevant_documents')}
												</div>
											</div>
										</div>
										<div className="accordion-item">
											<h2 className="accordion-header" id="headingSix">
												<button
													...
													aria-expanded="true"
													aria-controls="collapseSix">
													{c('How_long_does_it_take_to_resolve_a_civil_case')}
												</button>
											</h2>
											<div
												id="collapseSix"
												...
												data-bs-parent="#accordionExample">
												<div className="accordion-body border-0 text-white">
													{c('The_time_it_takes_to_resolve')}
												</div>
											</div>
										</div>
									</div>
