					...
					<div className="row mt-md-5">
						<div className="col-lg-12 col-xl-12 col-md-12">
							...
							<p className="weight-light font-small text-white">
								{t('The_Abu_Dhabi_Judicial_Divorce_Day_Phenomenon_in_the_UAE')}
							</p>
						</div>
					</div>
				</div>
									...
									<div className="accordion-item">
										<h2 className="accordion-header" id="headingOne">
											<button
												...
												{t('Divorce_Day_Phenomenon_in_the_UAE')}
											</button>
										</h2>
										<div
											id="collapseOne"
									...
									<div className="accordion-item">
										<h2 className="accordion-header" id="headingTwo1">
											<button
												...
												{t('Changing_Dynamics_in_Divorce_Rates')}
											</button>
										</h2>
										<div
											id="collapseTwo1"
											...
											data-bs-parent="#accordionExample">
											<div className="accordion-body border-0 text-white">
												{t('Despite_fluctuations_in_divorce')}
											</div>
										</div>
									</div>
									<div className="accordion-item">
										...
										<div
											...
											data-bs-parent="#accordionExample">
											<div className="accordion-body border-0 text-white">
												{t('Legal_professionals')}
												<br />
												<br />
												{t('If_your_facing_the_challenging')}
											</div>
										</div>
									</div>
								</div>
					...
					<div className="row sectionGap flex-wrap-none">
						<div className="col-lg-12 col-xl-5 col-md-12">
							<h2 className="font-smaller text-black  weight-bold mb-4">
								{t('The_Impact_of_')}{' '}
								<span className="green-medium-2">{t('Divorce_on_Business_Ownership')}</span>
							</h2>
							<Image
						...
						<div className="col-lg-11 col-12 col-xl-7 col-md-11" id="commoncause">
							<div className="accordion mt-5 margin-top-1" id="accordionExample">
								<div>{t('Divorce_can_have_significant')}</div>
								<div className="accordion-item">
									<h2 className="accordion-header" id="headingOne">
										<button
											...
											aria-expanded="true"
											aria-controls="collapseOne">
											{t('Business_Valuation_and_Asset_Division')}
										</button>
									</h2>
									<div
										id="collapseOne"
										...
										<div className="accordion-body border-0">
											{t('One_key_challenge_in_divorce')}
										</div>
									</div>
								</div>
								<div className="accordion-item">
									<h2 className="accordion-header" id="headingTwo">
										<button
											...
											{t('Protecting_Business_Interests')}
										</button>
									</h2>
									<div
										id="collapseTwo"
										...
										data-bs-parent="#accordionExample">
										<div className="accordion-body border-0">{t('During_divorce_proceedings')}</div>
									</div>
								</div>
								<div className="accordion-item">
									<h2 className="accordion-header" id="headingThree">
										<button
											...
											aria-expanded="false"
											aria-controls="collapseThree">
											{t('Business_Operations_and_Management')}
										</button>
									</h2>
									<div
										id="collapseThree"
										...
										data-bs-parent="#accordionExample">
										<div className="accordion-body border-0">
											{t('Divorce_can_also_impact')}
											<br />
											{t('Our_divorce_lawyers')}
										</div>
									</div>
								</div>
							</div>
						...
						<div className="col-lg-7 text-right order-lg-0 order-last">
							<div className="still" id="accordianSectionGreen">
								...
								<p className="font-medium weight-light text-black-add-fig mt-3">
									{t('Facing_divorce_in_UAE_and_seeking')}
								</p>
								<div className="accordion mt-4" id="setbotomspace">
									<div className="accordion-item">
										...
										<div
											...
											data-bs-parent="#accordionExample">
											<div className="accordion-body border-0">{t('our_Divorce_Lawyer_at')}</div>
										</div>
									</div>
									<div className="accordion-item">
										...
										<div
											...
											data-bs-parent="#accordionExample">
											<div className="accordion-body border-0">
												{t('At_Connect_Legal_we_understand')}
											</div>
										</div>
									</div>
									<div className="accordion-item">
										...
										<div
											...
											data-bs-parent="#accordionExample">
											<div className="accordion-body border-0">{t('our_Divorce_Lawyer')}</div>
										</div>
									</div>
									<div className="accordion-item">
									...
									<div className="accordion-item">
										...
										<div
											...
											data-bs-parent="#accordionExample">
											<div className="accordion-body border-0">
												{t('Navigating_a_divorce_can_be_emotionally')}
											</div>
										</div>
									</div>
									<div className="accordion-item">
										<h2 className="accordion-header" id="headingThirteen">
											<button
												...
												{t('Divorce_Lawyer_Dubai_Free_Consultation')}
											</button>
										</h2>
										<div
											id="collapseThirteen"
											...
											data-bs-parent="#accordionExample">
											<div className="accordion-body border-0">
												{t('With_the_best_divorce_lawyer_Dubai')}
											</div>
										</div>
									</div>
								</div>
				...
				<div className="container">
					<div className="still">
						<h3 className="font-xxx-large weight-bold text-black">
							{t('Discover_the')}{' '}
							<span className="green-medium-2">{t('Top_Divorce_Lawyers_in_Dubai')}</span>
						</h3>
						<p className="font-medium weight-light text-black-add-fig mt-3">
							{isMobileViewDiscover ? (
								<>
									{showFullTextDiscover ? (
										<>{t('When_searching_for_the_best_divorce')}</>
									) : (
										`${t('When_searching_for_the_best_divorce')}`
									)}
									<br />
			...
			<section id="legal-issues" className="legal-issues mobile-bg-color  mt-5 mb-5">
				<div className="container text-center">
					...
					<ul className="pt-3 class-add">
						...
						<li>
							<Link href="#">{t('Division_of_assets_and_property')}</Link>
						</li>
						<li>
							<Link href="#">{t('Spousal_support')}</Link>
						</li>
						<li>
							<Link href="#">{t('Legal_separation_vs')}</Link>
						</li>
						<li>
							<Link href="#">{t('Mediation_and_alternative')}</Link>
						</li>
					</ul>
				</div>
			</section>
							...
							<div className="row mt-5 benefit-margin" style={{ marginBottom: '65px' }}>
								<div className="col-lg-12">
									<div className="titleHow pt-lg-0">
										...
										{t('An_experienced_divorce_lawyer_offers')}
									</div>
								</div>
								<div className="col-lg-12">
									<div className="titleHow pt-lg-0">
										...
										<div className="text-start Discover-lawyer" />
										{t('Lawyers_act_as_skilled_negotiators')}
									</div>
								</div>
								<div className="col-lg-12">
									<div className="titleHow pt-lg-0">
										...
										<div className="text-start Discover-lawyer" />
										{t('In_cases_where_litigation_is_necessary')}
									</div>
								</div>
								<div className="col-lg-12">
									<div className="titleHow pt-lg-0">
										...
										<div className="text-start Discover-lawyer" />
										{t('Beyond_legal_expertise_a_divorce_')}
									</div>
								</div>
							</div>
						</div>
										...
										<div className="accordion-item">
											<h2 className="accordion-header" id="headingOne">
												<button
													...
													aria-expanded="true"
													aria-controls="collapseOne">
													{t('What_are_the_benefits_of_hiring_a_divorce_lawyer')}
												</button>
											</h2>
											<div
												id="collapseOne"
												...
												data-bs-parent="#accordionExample">
												<div className="accordion-body border-0 text-white">
													{t('Hiring_a_divorce_lawyer_provides_numerous_')}
												</div>
											</div>
										</div>
										<div className="accordion-item">
											<h2 className="accordion-header" id="headingTwo1">
												<button
													...
													aria-expanded="true"
													aria-controls="collapseTwo1">
													{t('How_much_does_a_divorce_lawyer_cost')}
												</button>
											</h2>
											<div
												id="collapseTwo1"
												...
												data-bs-parent="#accordionExample">
												<div className="accordion-body border-0 text-white">
													{t('The_cost_of_hiring_a_divorce_lawyer')}
												</div>
											</div>
										</div>
										<div className="accordion-item">
											<h2 className="accordion-header" id="headingThree">
												<button
													...
													aria-expanded="true"
													aria-controls="collapseThree">
													{t('What_role_does_a_divorce_lawyer_play_in_child_custody_cases')}
												</button>
											</h2>
											<div
												id="collapseThree"
												...
												data-bs-parent="#accordionExample">
												<div className="accordion-body border-0 text-white">
													{t('A_divorce_lawyer_can_assist_in_child_')}
												</div>
											</div>
										</div>
										<div className="accordion-item">
											<h2 className="accordion-header" id="headingFour">
												<button
													...
													{t(
														'Can_I_change_divorce_lawyers_if_Im_unsatisfied_with_my_current_representation'
													)}
												</button>
											</h2>
											<div
												...
												data-bs-parent="#accordionExample">
												<div className="accordion-body border-0 text-white">
													{t('Yes_you_have_the_right_to_change_')}
												</div>
											</div>
										</div>
										<div className="accordion-item">
											<h2 className="accordion-header" id="headingFive">
												<button
													...
													{t('Will_I_have_to_go_to_court_for_my_divorce')}
												</button>
											</h2>
											<div
												id="collapseFive"
												...
												data-bs-parent="#accordionExample">
												<div className="accordion-body border-0 text-white">
													{t('Not_necessarily—many_divorces_are_resolved')}
												</div>
											</div>
										</div>
										<div className="accordion-item">
											<h2 className="accordion-header" id="headingSix">
												<button
													...
													{t('How_long_does_the_divorce_process_typically_take')}
												</button>
											</h2>
											<div
												id="collapseSix"
												...
												data-bs-parent="#accordionExample">
												<div className="accordion-body border-0 text-white">
													{t('The_duration_of_the_divorce_process')}
												</div>
											</div>
										</div>
									</div>
