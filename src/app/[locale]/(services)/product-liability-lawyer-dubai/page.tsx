...
export async function generateMetadata(): Promise<Metadata> {
	return {
		title: 'Product Liability Lawyer in Dubai – Professional Women United',
		description:
			'For product liability cases, a product liability lawyer in Dubai can offer expert legal guidance. Contact Professional Women United for assistance.',
		alternates: {
