...
export async function generateMetadata(): Promise<Metadata> {
	return {
		title: 'Commercial Lawyer in Dubai – Connect Legal',
		description:
			'For commercial law issues, contact Connect Legal to find a commercial lawyer in Dubai who can provide strategic legal advice.',
		alternates: {
