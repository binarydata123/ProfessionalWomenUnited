...
export default function PremsiesLiabilityLawyer() {
	...
	const t = useTranslations('premisesLiabilityLawyer');
					...
					<div className="row">
						<div className="col-lg-7">
							<h1 className="font-larger weight-bold green-medium-dark mobile-m-0">
								{t('Premises_Liability_Lawyer_in_the_UAE')}
							</h1>
					...
					<div className="row mt-md-5 align-items-end">
						<div className="col-lg-4 col-md-12">
							<h2 className="font-smaller weight-bold text-white">
								<span className="green-med">{t('Understanding')}</span>{' '}
								<span className="green-med-col">{t('Premises_Liability')}</span>
							</h2>
							<p className="weight-light font-medium text-white mt-3">{t('Premises_liability_is_the')}</p>
						</div>
										...
										<div className="accordion mt-5" id="accordionExample">
											<div className="accordion-item">
												...
												<div
													...
													<div className="accordion-body border-0 text-white">
														{t('Personal_Injuries_in_the_UAE')}
														<br />
														{t('To_Guarantee_Appropriate')}
													</div>
												</div>
											</div>
											<div className="accordion-item">
												...
												<div
													...
													data-bs-parent="#accordionExample">
													<div className="accordion-body border-0 text-white">
														{t('Victims_in_Premises')}
														<ul className="pt-3 class-add">
															<li>
																<Link href="#">{t('Damages_Can_Be')}</Link>
															</li>
															<li>
																<Link href="#">{t('A_Close_Link_Between')} </Link>
															</li>
															<li>
																<Link href="#">{t('Victims_Have_the_Right')}</Link>
															</li>
														</ul>
													</div>
												</div>
											...
											<div className="accordion-item">
												...
												<div
													...
													data-bs-parent="#accordionExample">
													<div className="accordion-body border-0 text-white">
														{t('To_Reduce_the_Likelihood')}
														<br />
														{t('To_Maintain_Safety_Standards')}
													</div>
												</div>
											</div>
										</div>
					...
					<div className="row sectionGap flex-wrap-none">
						<div className="col-lg-12 col-xl-5 col-md-12">
							<h2 className="font-smaller text-black  weight-bold mb-4">
								{t('Common_Types_of')}{' '}
								<span className="green-medium-2">{t('Premises_Liability_Incidents')}</span>
							</h2>
							...
							<div className="accordion mt-5 margin-top-1" id="accordionExample">
								<div className="accordion-item">
									...
									<div
										...
										aria-labelledby="headingOne"
										data-bs-parent="#accordionExample">
										<div className="accordion-body border-0">{t('Slip_and_Fall_Accidents')}</div>
									</div>
								</div>
								<div className="accordion-item">
									...
									<div
										...
										data-bs-parent="#accordionExample">
										<div className="accordion-body border-0">{t('Property_Owners_May')}</div>
									</div>
								</div>
								<div className="accordion-item">
									<h2 className="accordion-header" id="headingThree">
									...
									<div
										...
										aria-labelledby="headingThree"
										data-bs-parent="#accordionExample">
										<div className="accordion-body border-0">{t('Defective_Conditions_on_a')}</div>
									</div>
								</div>
								<div className="accordion-item">
									...
									<div
										...
										aria-labelledby="headingThree"
										data-bs-parent="#accordionExample">
										<div className="accordion-body border-0">{t('Dog_Bites_Are_a_Common')}</div>
									</div>
								</div>
								<div className="accordion-item">
								...
								<div className="accordion-item">
									...
									<div
										...
										data-bs-parent="#accordionExample">
										<div className="accordion-body border-0">{t('Malfunctioning_Elevators')}</div>
									</div>
								</div>
								{/* <div className="accordion-item">
							...
							<div className="still" id="accordianSectionGreen">
								<h3 className="font-smaller weight-bold text-black-add-fig">
									...
									<span className="green-medium-2">
										{t('Premises_Liability_Lawyer')} <br />{' '}
									</span>{' '}
								...
								<div className="accordion mt-4" id="setbotomspace">
									...
									<div className="accordion-item">
										...
										<div
											...
											data-bs-parent="#accordionExample">
											<div className="accordion-body border-0">{t('Our_Premises_Liability')}</div>
										</div>
									</div>
									<div className="accordion-item">
										...
										<div
											...
											data-bs-parent="#accordionExample">
											<div className="accordion-body border-0">
												{t('Our_Premises_Liability_attorneys')}
											</div>
										</div>
									</div>
									<div className="accordion-item">
										...
										<div
											...
											data-bs-parent="#accordionExample">
											<div className="accordion-body border-0">
												{t('The_Premises_Liability_Lawyers')}
											</div>
										</div>
									</div>
									<div className="accordion-item">
										...
										<div
											...
											data-bs-parent="#accordionExample">
											<div className="accordion-body border-0">
												{t('Premises_Liability_Lawyers_on')}
											</div>
										</div>
									</div>
									{/* <div className="accordion-item">
				...
				<div className="container">
					<div className="still">
						...
						<h3 className="font-xxx-large weight-bold text-black mt-3 discover-font">
							{t('Discover_the')}{' '}
							<span className="green-medium-2">{t('Top_Premises_Liability_Lawyers_in_the_UAE')}</span>
						</h3>
						<p className="font-medium weight-light text-black-add-fig mt-3">
			...
			<section id="legal-issues" className="legal-issues mobile-bg-color  mt-5 mb-5">
				<div className="container text-center">
					...
					<p className="font-medium weight-medium social-link set-text-padding color-frequent set-top-mrgin-mbl">
						{t('When_Seeking_Legal')}
						<br />
						{t('Select_the_Legal_Issue')}
					</p>
					<ul className="pt-3 class-add">
						<li>
							<Link href="#">{t('Slip_and')}</Link>
						</li>
						<li>
							<Link href="#">{t('Negligent')}</Link>
						</li>
						<li>
							<Link href="#">{t('Property_Defects')}</Link>
						</li>
						<li>
							<Link href="#">{t('Dog_Bite_Incidents')}</Link>
						</li>
						<li>
							<Link href="#">{t('Swimming_Pool_Accidents')}</Link>
						</li>
						<li>
							<Link href="#">{t('Elevator_or_Escalator_Malfunctions')}</Link>
						</li>
					</ul>
				</div>
			</section>
						...
						<div className="col-lg-7 needlawyer-text-motor">
							<div className="titleHow">
								...
								<h2 className="text-black-add-fig Discover-lawyer discover-text-fun">
									...
									<span className="green-medium-2"> {t('Premises_liability')}</span>
							...
							<div className="row mt-5 benefit-margin" style={{ marginBottom: '65px' }}>
								<div className="col-lg-12">
									<div className="titleHow pt-lg-0">
										...
										{t('Premises_Liability_Lawyers_Conduct')}
									</div>
								</div>
								<div className="col-lg-12">
									<div className="titleHow pt-lg-0">
										...
										<div className="text-start Discover-lawyer" />
										{t('Premises_Liability_Lawyers_Play_a')}
									</div>
								</div>
								<div className="col-lg-12">
									<div className="titleHow pt-lg-0">
								...
								<div className="col-lg-12">
									<div className="titleHow pt-lg-0">
										...
										<div className="text-start Discover-lawyer" />
										{t('Premises_Liability_Lawyers_on_Our')}
									</div>
								</div>
							</div>
						</div>
									...
									<div className="accordion mt-5" id="accordionExample">
										<div className="accordion-item">
											...
											<div
												...
												data-bs-parent="#accordionExample">
												<div className="accordion-body border-0 text-white">
													{t('Premises_Liability_Refers_to')}
												</div>
											</div>
										</div>
										<div className="accordion-item">
