...
export async function generateMetadata(): Promise<Metadata> {
	return {
		title: 'Dubai Construction Lawyer – Professional Women United',
		description:
			'Navigate the complexities of the construction industry with a construction lawyer in Dubai. Professional Women United offers expert legal support.',
		alternates: {
