...
export default function MotorcycleAccidentLawyerDubai() {
	...
	const t = useTranslations('MotorcycleAccidentLawyer');
					...
					<div className="row">
						<div className="col-lg-7">
							<h1 className="font-larger weight-bold green-medium-dark mobile-m-0">
								{t('Motorcycle_Accident_Lawyer_in_Dubai')}
							</h1>
							<p className="weight-light social-link font-medium mt-4">
								{isMobileView ? (
									<>
										{showFullText ? (
											<>
												{t('A_motorcycle_accident_lawyer')}
					...
					<div className="row mt-md-5 align-items-end">
						<div className="col-lg-4 col-md-12">
							<h2 className="font-smaller weight-bold text-white">
								<span className="green-med">{t('Motorcycle_Accidents')}</span>{' '}
								<span className="green-med-col">{t('Statistics_UAE')}</span>
							</h2>
							<p className="weight-light font-medium text-white mt-3">{t('In_2022')}</p>
						</div>
							...
							<div className="row align-items-lg-center set-pad-stat set-mob-pad">
								...
								<div className="col-lg-11 col-9 p-lg-0">
									<p
										...
										{t('motorcycle_accidents_resulted')}
									</p>
								</div>
							</div>
						</div>
										...
										<div className="accordion mt-5" id="accordionExample">
											...
											<div className="accordion-item">
												...
												<div
													...
													data-bs-parent="#accordionExample">
													<div className="accordion-body border-0 text-white">
														{t('Concerning_severity')}
														<br />
														{t('These_findings')}
														<br />
														{t('For_those_involved')}
													</div>
												</div>
											</div>
										</div>
					...
					<div className="row sectionGap flex-wrap-none">
						<div className="col-lg-12 col-xl-5 col-md-12">
							<h2 className="font-smaller text-black  weight-bold mb-4">
								{t('Most_Common')} <span className="green-medium-2">{t('Motorcycle_accidents')}</span>
							</h2>
							<Image
							...
							<div className="accordion mt-5 margin-top-1" id="accordionExample">
								<div className="accordion-item">
									...
									<div
										...
										aria-labelledby="headingOne"
										data-bs-parent="#accordionExample">
										<div className="accordion-body border-0">{t('Human_error_is_a ')}</div>
									</div>
								</div>
								<div className="accordion-item">
									...
									<div
										...
										data-bs-parent="#accordionExample">
										<div className="accordion-body border-0">{t('Unsafe_road_conditions')}</div>
									</div>
								</div>
								<div className="accordion-item">
									<h2 className="accordion-header" id="headingThree">
									...
									<div
										...
										aria-labelledby="headingThree"
										data-bs-parent="#accordionExample">
										<div className="accordion-body border-0">{t('Vehicle-related_factors,')}</div>
									</div>
								</div>
								<div className="accordion-item">
									...
									<div
										...
										aria-labelledby="headingThree"
										data-bs-parent="#accordionExample">
										<div className="accordion-body border-0">{t('Inexperienced')}</div>
									</div>
								</div>
								<div className="accordion-item">
									...
									<div
										...
										data-bs-parent="#accordionExample">
										<div className="accordion-body border-0">{t('Impaired_riding')}</div>
									</div>
								</div>
								<div className="accordion-item">
									...
									<div
										...
										data-bs-parent="#accordionExample">
										<div className="accordion-body border-0">{t('Just_like_impaired')}</div>
									</div>
								</div>
								<div className="accordion-item">
									...
									<div
										...
										data-bs-parent="#accordionExample">
										<div className="accordion-body border-0">{t('Poor_weather_conditions')}</div>
									</div>
								</div>
							</div>
						</div>
								...
								<div className="accordion mt-4" id="setbotomspace">
									...
									<div className="accordion-item">
										...
										<div
											...
											data-bs-parent="#accordionExample">
											<div className="accordion-body border-0">{t('We_offer_comprehensive')}</div>
										</div>
									</div>
									<div className="accordion-item">
										...
										<div
											...
											data-bs-parent="#accordionExample">
											<div className="accordion-body border-0">{t('Connect_Legal_boasts')}</div>
										</div>
									</div>
									<div className="accordion-item">
										...
										<div
											...
											data-bs-parent="#accordionExample">
											<div className="accordion-body border-0">{t('Client_satisfaction_is')}</div>
										</div>
									</div>
								</div>
								<div className="about-btn-two mt-lg-5 mt-3">
				...
				<div className="container">
					<div className="still">
						...
						<h3 className="font-xxx-large weight-bold text-black mt-3 discover-font">
							{t('Discover_the')}{' '}
							<span className="green-medium-2">{t('Top_Motorcycle_Accident_Lawyers_in_Dubai')}</span>
						</h3>
						<p className="font-medium weight-light text-black-add-fig mt-3">
							{isMobileViewDiscover ? (
								<>
									{showFullTextDiscover ? (
										<>
											{t('At_Connect_Legal,_we_are_proud')}
											<br />
											{t('With_Connect_Legal,_clients')}
										</>
									) : (
			...
			<section id="legal-issues" className="legal-issues mobile-bg-color  mt-5 mb-5">
				<div className="container text-center">
					...
					<ul className="pt-3 class-add">
						<li>
							<Link href="#">{t('Compensation_for_injuries')}</Link>
						</li>
						<li>
							<Link href="#">{t('Liability_determination')}</Link>
						</li>
						<li>
							<Link href="#">{t('Insurance_claims')}</Link>
						</li>
						<li>
							<Link href="#">{t('Legal_rights_and_options')}</Link>
						</li>
						<li>
							<Link href="#">{t('Medical_expenses_coverage')}</Link>
						</li>
						<li>
							<Link href="#">{t('Negotiating_settlements')}</Link>
						</li>
					</ul>
				</div>
			</section>
						...
						<div className="col-lg-7 needlawyer-text-motor">
							<div className="titleHow">
								...
								<h2 className="text-black-add-fig Discover-lawyer discover-text-fun">
									...
									<span className="green-medium-2"> {t('Motorcycle')}</span>
							...
							<div className="row mt-5 benefit-margin" style={{ marginBottom: '65px' }}>
								<div className="col-lg-12">
									<div className="titleHow pt-lg-0">
										...
										{t('Our_motorcycle_accident_lawyers')}
									</div>
								</div>
								<div className="col-lg-12">
									<div className="titleHow pt-lg-0">
								...
								<div className="col-lg-12">
									<div className="titleHow pt-lg-0">
										...
										<div className="text-start Discover-lawyer" />
										{t('Our_motorcycle_accident_lawyers_in_the')}
									</div>
								</div>
								<div className="col-lg-12">
									<div className="titleHow pt-lg-0">
										...
										<div className="text-start Discover-lawyer" />
										{t('In_addition_to_legal_representation')}
									</div>
								</div>
							</div>
						</div>
