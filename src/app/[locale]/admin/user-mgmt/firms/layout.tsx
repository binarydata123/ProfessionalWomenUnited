...
export default function LawyersLayout({ children }: { children: React.ReactNode }) {
	...
	return (
		<div className="right-body overflow-hidden">
			...
			<h4 className="font-xx-large social-link weight-semi-bold mb-3 p-0 pt-4">Firms</h4>
			<div className="nav-tab use-lawyer p-set p-0 border-0">
				<ul className="border-bottom">
					<li className={pathname === '/admin/user-mgmt/firms' ? 'active' : ''}>
						<Link aria-current="page" href="/admin/user-mgmt/firms">
							All
						</Link>
					</li>
					<li className={pathname === '/admin/user-mgmt/firms/archived' ? 'active' : ''}>
						<Link href="/admin/user-mgmt/firms/archived">Archived</Link>
					</li>
