...
export default function AbuDhabiLawyers({ onclose }: any) {
						...
						<div className="tab-pane fade show active" role="tabpanel">
							<ul className="list-mega">
								<div>
									<div className="row align-items-center">
										...
										<div className="col-10 p-0">
											<h6 className="set-menu-head">{t('Criminal_Law')}</h6>
										</div>
									</div>
									<li>
										<Link
											href={`${locale !== 'en' ? `/${locale}` : ''}/criminal-lawyers-abu-dhabi`}
											onClick={onclose}
								...
								<div className="set-hading-pading">
									...
									<li>
										<Link
											href={`${locale !== 'en' ? `/${locale}` : ''}/divorce-lawyer-abu-dhabi`}
											onClick={onclose}
									...
									<li>
										<Link
											href={`${locale !== 'en' ? `/${locale}` : ''}/family-lawyer-abu-dhabi`}
											onClick={onclose}
								...
								<div className="set-hading-pading">
									...
									<li>
										<Link
											href={`${locale !== 'en' ? `/${locale}` : ''}/immigration-lawyer-abu-dhabi`}
											onClick={onclose}
				...
				<div>
					<Link
						...
						<span
							...
							{t('View_All_Lawyers_in_Abu_Dhabi')}
						</span>
