		...
		<div className="right-body overflow-hidden">
			...
			<section>
				<div id="legal-serve" className="pb-0">
					...
					<span>
						<Image src="/images/legal-service/arrow-right.png" alt="Reviews" width={16} height={16} />
					</span>
					<span>Reviews</span>
				</div>
			</section>
			<h4 className="font-xx-large social-link weight-semi-bold mb-3 p-0 pt-4">Reviews</h4>
			{children}
		</div>
	);
}
