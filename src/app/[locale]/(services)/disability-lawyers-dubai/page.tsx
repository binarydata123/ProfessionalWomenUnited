...
export async function generateMetadata(): Promise<Metadata> {
	return {
		title: 'Disability Lawyers in Dubai – Connect Legal',
		description:
			'Tackle disability law issues with a disability lawyer in Dubai. Connect Legal provides specialized advice to help you navigate these laws.',
		alternates: {
