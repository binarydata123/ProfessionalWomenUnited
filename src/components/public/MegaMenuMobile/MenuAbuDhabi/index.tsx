...
export default function MegaMenuAbuDhabi({ onclose }: any) {
	...
	const handleLinkClick = () => {
		...
		const collapseOne = document.getElementById('collapseOne2');
		if (collapseOne) {
					...
					<div className="accordion-item">
						<h2 className={`accordion-header ${isActive ? 'setMegaMenuAdd' : ''}`}>
							<button
								...
								<span onClick={() => { window.location.href = '/lawyers-in-abu-dhabi'; }}>{t('Abu_Dhabi')}</span>
						...
						<div
							...
							<div className="accordion-body">
								<ul className="list-mega set-scrol-menu abudhabi">
									<div>
										...
										<li>
											<Link
												href="/criminal-lawyers-abu-dhabi"
									...
									<div>
										...
										<li>
											<Link
												href="/immigration-lawyer-abu-dhabi"
												onClick={onclose}
												className="set-color-sub-menus">
