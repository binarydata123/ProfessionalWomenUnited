...
export default function MarriageLawyer() {
	...
	const t = useTranslations('marriageLawyer');
				...
				<div className="container">
					...
					<div className="row">
						...
						<div className="col-lg-5 text-right tab-center">
							<Image
								src="/images/legal-service/marriage_lawyer.jpeg"
								alt="AdobeStock"
											...
											<div className="accordion-item">
												<h2 className="accordion-header" id="headingOne">
													<button
														...
														{t('Marriage_Law_for_Interfaith_Couples')}
													</button>
												</h2>
												<div
													id="collapseOne"
											...
											<div className="accordion-item">
												...
												<div
													...
													<div className="accordion-body border-0 text-white">
														{t('Muslim_marriages')}
														<ul className="custom-bullets mt-3 mb-3">
															<li>{t('Marriage_contract')}</li>
															<li>{t('Legal_age')}</li>
															<li>{t('Age_difference')}</li>
															<li>{t('Premarital_screening')}</li>
															<li>{t('Attendance')}</li>
															<li>{t('Consent_the')}</li>
															<li>{t('Special_cases')}</li>
														</ul>
													</div>
												</div>
											</div>
											<div className="accordion-item">
												<h2 className="accordion-header" id="headingThree">
													<button
														...
														{t('Marriage_Laws_for_Non-Muslims_in_the_UAE')}
													</button>
												</h2>
												<div
													id="collapseThree"
													...
													data-bs-parent="#accordionExample">
													<div className="accordion-body border-0 text-white">
														{t('Non-Muslim_couples')}
														<ul className="custom-bullets mt-3 mb-3">
															<li>{t('Embassy_or_consulate')}</li>
															<li>{t('Religious_ceremony')}</li>
															<li>{t('Registration')}</li>
														</ul>
														{t('For_expert_guidance')}
													</div>
												</div>
											</div>
										</div>
					...
					<div className="row sectionGap flex-wrap-none">
						<div className="col-lg-12 col-xl-5 col-md-12">
							<h2 className="font-smaller text-black  weight-bold mb-4">
								{t('The_Importance_of_Prenuptial')}
								<span className="green-medium-2"> {t('Postnuptial_Agreements')}</span>
							</h2>
							<Image
								...
								<div className="accordion-item">
									...
									<div
										...
										<div className="accordion-body border-0">
											{t('Prenuptial_and_postnuptial_agreements')}
										</div>
									</div>
								</div>
								<div className="accordion-item">
									<h2 className="accordion-header" id="headingTwo">
										<button
											...
											{t('Protecting_Inherited_and_Personal_Assets')}
										</button>
									</h2>
									<div
										id="collapseTwo"
										...
										data-bs-parent="#accordionExample">
										<div className="accordion-body border-0">{t('These_agreements_allow')}</div>
									</div>
								</div>
								<div className="accordion-item">
									<h2 className="accordion-header" id="headingThree">
										<button
											...
											aria-expanded="false"
											aria-controls="collapseThree">
											{t('Addressing_Debts_and_Liabilities')}
										</button>
									</h2>
									<div
										id="collapseThree"
										...
										aria-labelledby="headingThree"
										data-bs-parent="#accordionExample">
										<div className="accordion-body border-0">{t('Couples_can_specify_how')}</div>
									</div>
								</div>
								<div className="accordion-item">
									<h2 className="accordion-header" id="headingfour">
										<button
											...
											{t('Streamlining_Legal_Proceedings')}
										</button>
									</h2>
									<div
										id="collapsefour"
										...
										data-bs-parent="#accordionExample">
										<div className="accordion-body border-0">
											{t('By_predefining_terms_in_these')}
										</div>
									</div>
								</div>
							</div>
									...
									<div className="accordion-item">
										<h2 className="accordion-header" id="headingEight">
											<button
												...
												{t('Expertise_in_UAE_Marriage_Laws')}
											</button>
										</h2>
										<div
											id="collapseEight"
											...
											data-bs-parent="#accordionExample">
											<div className="accordion-body border-0">
												{t('A_marriage_lawyer_from_Connect_Legal')}
												<br />
												{t('The_lawyer_expertise_ensures')}
											</div>
										</div>
									</div>
									<div className="accordion-item">
										...
										<div
											...
											data-bs-parent="#accordionExample">
											<div className="accordion-body border-0">
												{t('Connect_Legal_marriage_lawyers')}
												<br /> {t('This_personalized_approach')}
											</div>
										</div>
									</div>
									<div className="accordion-item">
										<h2 className="accordion-header" id="headingTen">
											<button
												...
												{t('Efficient_Handling_of_Paperwork')}
											</button>
										</h2>
										<div
											id="collapseTen"
											...
											data-bs-parent="#accordionExample">
											<div className="accordion-body border-0">
												{t('The_marriage_process_in_the_UAE')}
												<br /> {t('This_attention_to_detail_helps')}
											</div>
										</div>
									</div>
									<div className="accordion-item">
										...
										<div
											...
											data-bs-parent="#accordionExample">
											<div className="accordion-body border-0">
												{t('In_the_rare_event_of_legal_disputes')}
												<br /> {t('With_their_expertise_in_local_laws')}
											</div>
										</div>
									</div>
									<div className="accordion-item">
										...
										<div
											...
											data-bs-parent="#accordionExample">
											<div className="accordion-body border-0">
												{t('Connect_Legal_has_a_history')}
												<br /> {t('This_success_demonstrates')}
											</div>
										</div>
									</div>
									<div className="accordion-item">
										...
										<div
											...
											data-bs-parent="#accordionExample">
											<div className="accordion-body border-0">
												{t('By_hiring_the_services')}
												<br />
												{t('Their_attention_to_detail')}
											</div>
										</div>
									</div>
								</div>
				...
				<div className="container">
					<div className="still">
						...
						<h3 className="font-xxx-large weight-bold text-black mt-3 discover-font">
							{t('Discover_the')}
							<span className="green-medium-2"> {t('Top_Marriage_Lawyers_in_Dubai')}</span>
						</h3>
							...
							{isMobileViewDiscover ? (
								<>
									{showFullTextDiscover ? (
										<>
											{t('Are_you_looking_for_the_best')}
											<br /> {t('At_Connect_Legal,_our_top_marriage ')}
										</>
									) : (
										'Are you looking for the best marriage lawyer in Dubai? You’re in the right place. '
									)}
									<br />
									<div className="mt-3 mb-3 d-lg-none d-block weight-bold ">
										<Link
			...
			<section id="legal-issues" className="legal-issues mobile-bg-color  mt-5 mb-5">
				<div className="container text-center">
					...
					<p className="font-medium weight-medium social-link set-text-padding color-frequent set-top-mrgin-mbl">
						{t('Clients_seeking_legal_information')}
						<br />
						{t('Select_the_legal_issue')}
					</p>
					<ul className="pt-3 class-add">
						<li>
							<Link href="#">{t('Interfaith_marriages')}</Link>
						</li>
						<li>
							<Link href="#">{t('Muslim_marriage')}</Link>
						</li>
						<li>
							<Link href="#">{t('Non-Muslim_marriages')}</Link>
						</li>
						<li>
							<Link href="#">{t('Pre-marital_screening')}</Link>
						</li>
						<li>
							<Link href="#">{t('Marriage_contract_registration')}</Link>
						</li>
						<li>
							<Link href="#">{t('Legal_disputes')}</Link>
						</li>
					</ul>
				</div>
			</section>
						...
						<div className="col-lg-7 needlawyer-text-motor">
							<div className="titleHow">
								...
								<h2 className="text-black-add-fig Discover-lawyer discover-text-fun">
									...
									<span className="green-medium-2"> {t('Marriage')}</span>
							...
							<div className="row mt-5 benefit-margin" style={{marginBottom: '65px'}}>
								<div className="col-lg-12">
									<div className="titleHow pt-lg-0">
										...
										{t('A_marriage_lawyer_can_provide')}
									</div>
								</div>
								<div className="col-lg-12">
									<div className="titleHow pt-lg-0">
										...
										<div className="text-start Discover-lawyer" />
										{t('Marriage_lawyers_are_instrumental')}
									</div>
								</div>
								<div className="col-lg-12">
									<div className="titleHow pt-lg-0">
										...
										<div className="text-start Discover-lawyer" />
										{t('In_cases_where_disputes_or_legal')}
									</div>
								</div>
								<div className="col-lg-12">
									<div className="titleHow pt-lg-0">
										...
										<div className="text-start Discover-lawyer" />
										{t('A_marriage_lawyer_can_also_assist')}
									</div>
								</div>
							</div>
						</div>
									...
									<div className="accordion mt-5" id="accordionExample">
										...
										<div className="accordion-item">
											...
											<div
												...
												data-bs-parent="#accordionExample">
												<div className="accordion-body border-0 text-white">
													{t('Prenuptial_agreements_are_legal')}
												</div>
											</div>
										</div>
										<div className="accordion-item">
										...
										<div className="accordion-item">
											...
											<div
												...
												data-bs-parent="#accordionExample">
												<div className="accordion-body border-0 text-white">
													{t('A_marriage_lawyer_can_represent')}
												</div>
											</div>
										</div>
									</div>
