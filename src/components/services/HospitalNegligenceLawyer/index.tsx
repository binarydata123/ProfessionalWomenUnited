...
export default function HospitalNegligenceLawyer() {
	const t = useTranslations('hospitalNegligenceLawyerUAE');
					...
					<div className="row">
						<div className="col-lg-7">
							<h1 className="font-larger weight-bold green-medium-dark mobile-m-0">
								{t('Hospital_Negligence_Lawyer_in_Dubai')}
							</h1>
							<p className="weight-light social-link font-medium mt-4">
								{isMobileView ? (
									<>
										{showFullText ? (
											<>{t('A_hospital_negligence_lawyer')}</>
										) : (
											`${t('A_hospital_negligence_lawyer')}`
										)}
										<br />
											...
											<div className="accordion-item">
												<h2 className="accordion-header" id="headingTwo1">
													<button
														...
														{t('Importance_of_Medical_Negligence_Law')}
													</button>
												</h2>
												<div
													id="collapseTwo1"
											...
											<div className="accordion-item">
												<h2 className="accordion-header" id="headingThree">
													<button
														...
														{t('Resolution_Mechanism_and_Legal_Procedure')}
													</button>
												</h2>
												<div
													id="collapseThree"
					...
					<div className="row sectionGap flex-wrap-none">
						<div className="col-lg-12 col-xl-5 col-md-12">
							<h2 className="font-smaller text-black  weight-bold mb-4">
								{t('Consequences_of')}{' '}
								<span className="green-medium-2">{t('Hospital_Negligence')}</span>
							</h2>
							<Image
							...
							<div className="accordion mt-5 margin-top-1" id="accordionExample">
								<div className="accordion-item">
									...
									<div
										...
										aria-labelledby="headingOne"
										data-bs-parent="#accordionExample">
										<div className="accordion-body border-0">{t('Hospital_negligence_can')}</div>
									</div>
								</div>
								<div className="accordion-item">
									<h2 className="accordion-header" id="headingTwo">
										<button
											...
											{t('Emotional_Distress_and_Psychological_Trauma')}
										</button>
									</h2>
									<div
										id="collapseTwo"
										...
										<div className="accordion-body border-0">
											{t('Hospital_negligence_can_cause')}
											<br />
											{t('Witnessing_the_suffering_of')}
										</div>
									</div>
								</div>
								<div className="accordion-item">
									...
									<div
										...
										data-bs-parent="#accordionExample">
										<div className="accordion-body border-0">
											{t('Hospital__negligence')}
											<br />
											{t('The_inability_to_work')}
										</div>
									</div>
								</div>
								<div className="accordion-item">
									<h2 className="accordion-header" id="headingfour">
										<button
											...
											{t('Loss_of_Trust_in_Healthcare_Providers')}
										</button>
									</h2>
									<div
										id="collapsefour"
										...
										data-bs-parent="#accordionExample">
										<div className="accordion-body border-0">
											{t('Hospital_negligence')}
											<br />
											{t('This_loss_of_trust_can')}
										</div>
									</div>
								</div>
								<div className="accordion-item">
									<h2 className="accordion-header" id="headingFive">
										<button
											...
											{t('Complications_and_Prolonged_Recovery')}
										</button>
									</h2>
									<div
										id="collapseFive"
										...
										data-bs-parent="#accordionExample">
										<div className="accordion-body border-0">
											{t('Hospital_negligence_can_result')}
										</div>
									</div>
								</div>
								<div className="accordion-item">
									<h2 className="accordion-header" id="headingSix">
										<button
											...
											{t('Loss_of_Life_and_Wrongful_Death')}
										</button>
									</h2>
									<div
										id="collapseSix"
										...
										data-bs-parent="#accordionExample">
										<div className="accordion-body border-0">
											{t('In_the_most_tragic_cases')}
											<br />
											{t('The_untimely_loss_of_a')}
										</div>
									</div>
								</div>
							</div>
								...
								<div className="accordion mt-4" id="setbotomspace">
									<div className="accordion-item">
										<h2 className="accordion-header" id="headingEight">
											<button
												...
												{t('Expertise_in_Hospital_Negligence_Cases')}
											</button>
										</h2>
										<div
											id="collapseEight"
									...
									<div className="accordion-item">
										...
										<div
											...
											data-bs-parent="#accordionExample">
											<div className="accordion-body border-0">{t('Connect_Legal_connects')}</div>
										</div>
									</div>
									<div className="accordion-item">
									...
									<div className="accordion-item">
										...
										<div
											...
											data-bs-parent="#accordionExample">
											<div className="accordion-body border-0">
												{t('Hiring_a_hospital_negligence')}
											</div>
										</div>
									</div>
									<div className="accordion-item">
										<h2 className="accordion-header" id="headingTweleve">
											<button
												...
												{t('Transparent_Communication_and_Fees')}
											</button>
										</h2>
										<div
											id="collapseTweleve"
											...
											data-bs-parent="#accordionExample">
											<div className="accordion-body border-0">
												{t('When_working_with_a_hospital')}
												<br />
												{t('This_open_communication')}
											</div>
										</div>
									</div>
									<div className="accordion-item">
										<h2 className="accordion-header" id="headingThirteen">
											<button
												...
												{t('Compassionate_and_Supportive_Representation')}
											</button>
										</h2>
										<div
											id="collapseThirteen"
				...
				<div className="container">
					<div className="still">
						...
						<h3 className="font-xxx-large weight-bold text-black mt-3 discover-font">
							{t('Discover_the')}{' '}
							<span className="green-medium-2">{t('Top_Hospital_Negligence_Lawyers_in_Dubai')}</span>
						</h3>
			...
			<section id="legal-issues" className="legal-issues mobile-bg-color  mt-5 mb-5">
				<div className="container text-center">
					...
					<ul className="pt-3 class-add">
						...
						<li>
							<Link href="#">{t('Finding_experienced_hospital_negligence_lawyers')}</Link>
						</li>
						<li>
							<Link href="#">{t('Determining_liability_for_medical_errors')}</Link>
						</li>
						<li>
							<Link href="#">{t('Seeking_compensation_for_medical_expenses_and_damages')}</Link>
						</li>
						<li>
							<Link href="#">{t('Exploring_options_for_resolving_hospital_negligence_claims')}</Link>
						</li>
					</ul>
				</div>
			</section>
						...
						<div className="col-lg-7 needlawyer-text-motor">
							<div className="titleHow">
								...
								<h2 className="text-black-add-fig Discover-lawyer discover-text-fun">
									...
									<span className="green-medium-2"> {t('Hospital')}</span>
									{t('Negligence_Related_Legal_Matters')}
								</h2>
								<div className="mt-4">
									<Link href={'/find-a-lawyer'}>
							...
							<div className="row mt-5 benefit-margin" style={{marginBottom: '65px'}}>
									...
									<div className="titleHow pt-lg-0">
										<div className=" pt-4">
											<h4 className="text-start weight-bold" style={{color: '#c49073'}}>
												{t('Legal_Guidance_and_Advice')}
											</h4>
										</div>
										<div className="text-start Discover-lawyer" />
										{t('Hospital_negligence_lawyers')}
									</div>
								</div>
								<div className="col-lg-12">
									<div className="titleHow pt-lg-0">
										<div className=" pt-4">
											<h4 className="text-start weight-bold" style={{color: '#c49073'}}>
												{t('Investigation_and_Case_Preparation')}
											</h4>
										</div>
										<div className="text-start Discover-lawyer" />
										{t('Hospital_negligence_lawyers_thoroughly')}
									</div>
								</div>
								<div className="col-lg-12">
									<div className="titleHow pt-lg-0">
										<div className=" pt-4">
											<h4 className="text-start weight-bold" style={{color: '#c49073'}}>
												{t('Advocacy_and_Representation')}
											</h4>
										</div>
										<div className="text-start Discover-lawyer" />
										{t('Hospital_negligence_lawyers_are_dedicated')}
									</div>
								</div>
								...
								<div className="col-lg-12">
									<div className="titleHow pt-lg-0">
										<div className=" pt-4">
											<h4 className="text-start weight-bold" style={{color: '#c49073'}}>
												{t('Settlement_Negotiations_and_Litigation')}
											</h4>
										</div>
										<div className="text-start Discover-lawyer" />
										{t('Hospital_negligence_lawyers_can')}
									</div>
								</div>
							</div>
						</div>
										...
										<div className="accordion-item">
											<h2 className="accordion-header" id="headingTwo1">
												<button
													...
													aria-expanded="true"
													aria-controls="collapseTwo1">
													{t('How_do_I_know_if_I_have_a_hospital_negligence_case')}
												</button>
											</h2>
											<div
												id="collapseTwo1"
										...
										<div className="accordion-item">
											<h2 className="accordion-header" id="headingThree">
												<button
													...
													aria-controls="collapseThree">
													{t(
														'What_compensation_can_I_receive_in_a_hospital_negligence_claim'
													)}
												</button>
											</h2>
											<div
										...
										<div className="accordion-item">
											<h2 className="accordion-header" id="headingFour">
												<button
													...
													aria-controls="collapseFour">
													{t(
														'How_long_do_I_have_to_file_a_hospital_negligence_claim_in_Dubai'
													)}
												</button>
											</h2>
											<div
												...
												data-bs-parent="#accordionExample">
												<div className="accordion-body border-0 text-white">
													{t('The_statute_of_limitations_for_filing')}
												</div>
											</div>
										</div>
										<div className="accordion-item">
											<h2 className="accordion-header" id="headingFive">
												<button
													...
													aria-expanded="true"
													aria-controls="collapseFive">
													{t('Can_I_afford_to_hire_a_hospital_negligence_lawyer')}
												</button>
											</h2>
											<div
												id="collapseFive"
