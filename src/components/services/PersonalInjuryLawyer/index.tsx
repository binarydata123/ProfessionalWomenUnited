...
export default function PersonalInjuryLawyer() {
	...
	const t = useTranslations("personalinjury");
					...
					<div className="row">
						<div className="col-lg-7">
							<h1 className="font-larger weight-bold green-medium-dark mobile-m-0">
								{t('Personal_Injury_Lawyer_in_Dubai')}
							...
							<p className="weight-light social-link font-medium mt-4">
								{isMobileView ? (
									<>
										{showFullText ? (
											<>
												{t('A_personal_injury_lawyer_represents')}												<br />
												{t('At_Connect_Legal,_we_facilitate_access')}											</>
										) : (
											'A personal injury lawyer represents individuals who have been injured due to the negligence or wrongdoing of others. They provide legal guidance and advocacy to help clients pursue compensation for their injuries, damages, and losses.'
										)}
										<br />
						...
						<div className="col-lg-5 text-right tab-center">
							<Image src="/images/legal-service/motorcycle_accident_lawyer.jpeg" alt="AdobeStock" className="effect show-hide" width={516} height={344} style={{ borderRadius: '8px' }} />
					...
					<div className="row mt-md-5 align-items-end">
						<div className="col-lg-4 col-md-12">
							<h2 className="font-smaller weight-bold text-white">
								<span className="green-med">{t('Global_Impact_of_Personal_Injury')}</span>{' '}
								<span className="green-med-col">{t('Personal_Injurys')}</span>
							</h2>
							<p className="weight-light font-medium text-white mt-3">
								{t('Personal_injury_refers_to_physical')}								<br />
								{t('Personal_injury_law_helps')}
							</p>
						</div>
										...
										<div className="accordion mt-5" id="accordionExample">
											...
											<div className="accordion-item">
												...
												<div
													...
													data-bs-parent="#accordionExample">
													<div className="accordion-body border-0 text-white">
														{t('Slip_and_fall_accidents_occur')}														</div>
												</div>
											</div>
											<div className="accordion-item">
					...
					<div className="row sectionGap flex-wrap-none">
						<div className="col-lg-12 col-xl-5 col-md-12">
							<h2 className="font-smaller text-black  weight-bold mb-4">
								{t('Compensation_Options_for_Personal_Injury_Victims')} <span className="green-medium-2">{t('Personal_Injury_Victims')}	</span>
							</h2>
							...
							<div className="accordion mt-5 margin-top-1" id="accordionExample">
								...
								<div className="accordion-item">
									...
									<div
										...
										data-bs-parent="#accordionExample">
										<div className="accordion-body border-0">
											{t('Injuries_sustained_in_personal')}											</div>
									</div>
								</div>
								<div className="accordion-item">
									<h2 className="accordion-header" id="headingThree">
								...
								<div className="accordion-item">
									...
									<div
										...
										data-bs-parent="#accordionExample">
										<div className="accordion-body border-0">
											{t('Serious_injuries_received')}											</div>
									</div>
								</div>
								<div className="accordion-item">
									...
									<div
										...
										data-bs-parent="#accordionExample">
										<div className="accordion-body border-0">
											{t('In_cases_where_a_personal_injury')}											</div>
									</div>
								</div>
							</div>
						</div>
							...
							<div className="still" id="accordianSectionGreen">
								<h3 className="font-smaller weight-bold text-black-add-fig">
									...
									<span className="green-medium-2">
										{t('Personal_Injury_Lawyer')} <br />{' '}
									</span>{' '}
									{t('from_Connect_Legal?')}								</h3>
								<div className="accordion mt-4" id="setbotomspace">
									<div className="accordion-item">
										<h2 className="accordion-header" id="headingEight">
											<button
												...
												{t('Expertise_in_Personal_Injury_Law')}
											</button>
										</h2>
										<div
											id="collapseEight"
									...
									<div className="accordion-item">
										...
										<div
											...
											data-bs-parent="#accordionExample">
											<div className="accordion-body border-0">
												{t('We_have_the_best_personal')}												</div>
										</div>
									</div>
									<div className="accordion-item">
										<h2 className="accordion-header" id="headingEleven">
											<button
												...
												{t('Effective_Communication_and_Support')}
										...
										<div
											...
											data-bs-parent="#accordionExample">
											<div className="accordion-body border-0">
												{t('The_attorneys_on_our_platform')}											</div>
										</div>
									</div>
									<div className="accordion-item">
										<h2 className="accordion-header" id="headingTweleve">
											<button
												...
												{t('Compassionate_Client_Centered_Approach')}
											</button>
										</h2>
										<div
											id="collapseTweleve"
											...
											data-bs-parent="#accordionExample">
											<div className="accordion-body border-0">
												{t('At_Connect_Legal,_we_prioritize')}
											</div>
										</div>
									</div>
								</div>
				...
				<div className="container">
					<div className="still">
						...
						<h3 className="font-xxx-large weight-bold text-black mt-3 discover-font">
							{t('Discover_the')}
							<span className="green-medium-2">{t('Top_Personal')}</span>
						</h3>
			...
			<section id="legal-issues" className="legal-issues mobile-bg-color  mt-5 mb-5">
				<div className="container text-center">
					...
					<p className="font-medium weight-medium social-link set-text-padding color-frequent set-top-mrgin-mbl">
						{t('Clients_frequently_search')}<br />
						{t('Select_the_legal')}
					</p>
					<ul className="pt-3 class-add">
						<li>
							<Link href="#">{t('Understanding_legal')}</Link>
						</li>
						<li>
							<Link href="#">{t('Determining_liability')}</Link>
						</li>
						<li>
							<Link href="#">{t('Seeking_compensation')}</Link>
						</li>
						<li>
							<Link href="#">{t('Evaluating_the_strength')}</Link>
						</li>
						<li>
							<Link href="#">{t('Navigating_the_legal')}
							...
							<div className="row mt-5 benefit-margin" style={{ marginBottom: '65px' }}>
								<div className="col-lg-12">
									<div className="titleHow pt-lg-0">
										...
										{t('Personal_injury_lawyers_offer')}
									</div>
								</div>
								<div className="col-lg-12">
									<div className="titleHow pt-lg-0">
										...
										<div className="text-start Discover-lawyer" />
										{t('Personal_injury_lawyers')}										<br />
										{t('By_presenting_persuasive')}
									</div>
								</div>
								<div className="col-lg-12">
									<div className="titleHow pt-lg-0">
										...
										<div className="text-start Discover-lawyer" />
										{t('Personal_injury_lawyers_negotiate')}										</div>
								</div>
								...
								<div className="col-lg-12">
									<div className="titleHow pt-lg-0">
										...
										<div className="text-start Discover-lawyer" />
										{t('In_cases_where_settlement')}									</div>
								</div>
							</div>
						</div>
					</div>
										...
										<div className="accordion-item">
											<h2 className="accordion-header" id="headingOne">
												<button
													...
													aria-expanded="true"
													aria-controls="collapseOne">
													{t('What_types_of_cases_fall_under_personal_injury_law?')}
												</button>
											</h2>
											<div
												id="collapseOne"
										...
										<div className="accordion-item">
											<h2 className="accordion-header" id="headingTwo1">
												<button
													...
													aria-expanded="true"
													aria-controls="collapseTwo1">
													{t('How_do_I_know_if_I_have_a_valid_personal_injury_claim?')}
												</button>
											</h2>
											<div
												id="collapseTwo1"
												...
												data-bs-parent="#accordionExample">
												<div className="accordion-body border-0 text-white">
													{t('If_you_have_been_injured')}												</div>
											</div>
										</div>
										<div className="accordion-item">
											<h2 className="accordion-header" id="headingThree">
												<button
													...
													aria-expanded="true"
													aria-controls="collapseThree">
													{t('What_compensation_can_I_expect_to_receive_in_a_personal_injury_case?')}
												</button>
											</h2>
											<div
												id="collapseThree"
												...
												data-bs-parent="#accordionExample">
												<div className="accordion-body border-0 text-white">
													{t('Compensation_in_personal_injury')}
												</div>
											</div>
										</div>
										<div className="accordion-item">
										...
										<div className="accordion-item">
											<h2 className="accordion-header" id="headingFive">
												<button
													...
													aria-expanded="true"
													aria-controls="collapseFive">
													{t('Do_I_need_a_lawyer_for_my_personal_injury_case?')}
												</button>
											</h2>
											<div
												id="collapseFive"
												...
												data-bs-parent="#accordionExample">
												<div className="accordion-body border-0 text-white">
													{t('While_you_are_not_required')}													</div>
											</div>
										</div>
									</div>
								</div>
