...
export async function generateMetadata(): Promise<Metadata> {
	return {
		title: 'Construction Accident Lawyers in UAE – Connect Legal',
		description:
			'Injured on a construction site? A construction accident lawyer in UAE can help. Contact Connect Legal for expert advice.',
		alternates: {
