...
export async function generateMetadata(): Promise<Metadata> {
	return {
		...
		description:
			'Professional Women United simplifies finding the best lawyer in Dubai. Our platform connects you with top legal professionals in the USA for your case. Try it now!',
		alternates: {
