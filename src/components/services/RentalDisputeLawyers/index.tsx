...
export default function RentalDisputeLawyers() {
	...
	const t = useTranslations('rentalDisputeLawyer');
					...
					<div className="row">
						<div className="col-lg-7">
							<h1 className="font-larger weight-bold green-medium-dark mobile-m-0">
								{t('Rental_Dispute_Lawyers_in_Dubai')}
							</h1>
						...
						<div className="col-lg-5 text-right tab-center">
							<Image
								src="/images/legal-service/rental_dispute_lawyers.jpeg"
								alt="AdobeStock"
					...
					<div className="row mt-md-5 align-items-end">
						<div className="col-lg-12 col-xl-12 col-md-12">
							<h2 className="font-smaller weight-bold text-white">
								<span className="green-med">{t('Rental_and_Property')}</span>{' '}
								<span className="green-med-col">{t('Statistics_in_UAE')}</span>
							</h2>
							<div className="accordion-body border-0 text-white">
								{t('The_rental_market_in_Dubai')}
								<ul className="custom-bullets mt-3 mb-3">
									<li>{t('Rising_villa_and_apartment_rents')}</li>
									<li>{t('Increased_rental_notices')}</li>
									<li>{t('Strong_property_sales_and_growth')}</li>
								</ul>
							</div>
						</div>
											...
											<div className="accordion-item">
												<h2 className="accordion-header" id="headingOne">
													<button
														...
														{t('Widening_Gap_Between_New_Contracts_and_Renewals')}
													</button>
												</h2>
												<div
													id="collapseOne"
													...
													<div className="accordion-body border-0 text-white">
														{t('The_rental_market_in_Dubai_is_experiencing')}
													</div>
												</div>
											</div>
											<div className="accordion-item">
												...
												<div
													...
													data-bs-parent="#accordionExample">
													<div className="accordion-body border-0 text-white">
														{t('As_a_consequence_of_the_widening_gap')}
													</div>
												</div>
											</div>
											<div className="accordion-item">
												<h2 className="accordion-header" id="headingThree">
													<button
														...
														{t('Market_Upheaval_and_Regulatory')}
													</button>
												</h2>
												<div
													id="collapseThree"
					...
					<div className="row sectionGap flex-wrap-none">
						<div className="col-lg-12 col-xl-5 col-md-12">
							<h2 className="font-smaller text-black  weight-bold mb-4">
								{t('Common_Rental_Disputes')}{' '}
								<span className="green-medium-2">{t('Real_Estate_Market')}</span>
							</h2>
							<Image
								...
								<div className="accordion-item">
									<h2 className="accordion-header" id="headingOne">
										<button
											...
											aria-expanded="true"
											aria-controls="collapseOne">
											{t('Disputes_Over_Rental_Increases')}
										</button>
									</h2>
									<div
										id="collapseOne"
										...
										<div className="accordion-body border-0">
											{t('One_common_reason_for_rental')}
										</div>
									</div>
								</div>
								<div className="accordion-item">
									...
									<div
										...
										data-bs-parent="#accordionExample">
										<div className="accordion-body border-0">
											{t('Another_frequent_source_of_rental')}
										</div>
									</div>
								</div>
								<div className="accordion-item">
									<h2 className="accordion-header" id="headingThree">
										<button
											...
											aria-expanded="false"
											aria-controls="collapseThree">
											{t('Maintenance_and_Repair_Conflicts')}
										</button>
									</h2>
									<div
										id="collapseThree"
										...
										data-bs-parent="#accordionExample">
										<div className="accordion-body border-0">
											{t('Maintenance_and_repair_issues_often')}
										</div>
									</div>
								</div>
								<div className="accordion-item">
									...
									<div
										...
										aria-labelledby="headingThree"
										data-bs-parent="#accordionExample">
										<div className="accordion-body border-0">{t('Disputes_can_arise_when')}</div>
									</div>
								</div>
								<div className="accordion-item">
									<h2 className="accordion-header" id="headingFive">
										<button
											...
											{t('Disagreements_Over_Lease_Terms')}
										</button>
									</h2>
									<div
										id="collapseFive"
										...
										data-bs-parent="#accordionExample">
										<div className="accordion-body border-0">
											{t('Misunderstandings_and_disagreements')}
										</div>
									</div>
								</div>
								<div className="accordion-item">
									...
									<div
										...
										data-bs-parent="#accordionExample">
										<div className="accordion-body border-0">{t('Eviction_disputes_can')}</div>
									</div>
								</div>
							</div>
						</div>
								...
								<div className="accordion mt-4" id="setbotomspace">
									<div className="accordion-item">
										...
										<div
											...
											data-bs-parent="#accordionExample">
											<div className="accordion-body border-0">{t('Connect_Legal_rental')}</div>
										</div>
									</div>
									<div className="accordion-item">
										<h2 className="accordion-header" id="headingNine">
											<button
												...
												{t('Proven_Success_in_Resolving_Disputes')}
											</button>
										</h2>
										<div
											id="collapseNine"
											...
											data-bs-parent="#accordionExample">
											<div className="accordion-body border-0">
												{t('The_rental_dispute_lawyers_in')}
											</div>
										</div>
									</div>
									<div className="accordion-item">
									...
									<div className="accordion-item">
										<h2 className="accordion-header" id="headingEleven">
											<button
												...
												{t('Strong_Negotiation_and_Mediation_Skills')}
											</button>
										</h2>
										<div
											id="collapseEleven"
											...
											data-bs-parent="#accordionExample">
											<div className="accordion-body border-0">
												{t('The_rental_dispute_lawyers_at_Connect')}
											</div>
										</div>
									</div>
									<div className="accordion-item">
										<h2 className="accordion-header" id="headingTweleve">
											<button
												...
												{t('Efficient_Handling_of_Legal_Procedures')}
											</button>
										</h2>
										<div
											id="collapseTweleve"
											...
											data-bs-parent="#accordionExample">
											<div className="accordion-body border-0">{t('Connect_Legal_network')}</div>
										</div>
									</div>
									<div className="accordion-item">
										<h2 className="accordion-header" id="headingThirteen">
											<button
												...
												{t('Client-Centered_Approach_and_Support')}
											</button>
										</h2>
										<div
											id="collapseThirteen"
											...
											data-bs-parent="#accordionExample">
											<div className="accordion-body border-0">{t('Rental_dispute_lawyers')}</div>
										</div>
									</div>
								</div>
								<div className="about-btn-two mt-lg-5 mt-3">
				...
				<div className="container">
					<div className="still">
						...
						<h3 className="font-xxx-large weight-bold text-black mt-3 discover-font">
							{t('Discover_the')}{' '}
							<span className="green-medium-2">{t('Top_Rental_Dispute_Lawyers_in_Dubai')}</span>
						</h3>
						<p className="font-medium weight-light text-black-add-fig mt-3">
							{isMobileViewDiscover ? (
								<>
									{showFullTextDiscover ? (
										<>
											{t('At_Connect_Legal_you')}
											<br />
											{t('The_rental_dispute_lawyers_in_our_network')} <br />
								...
								<>
									{t('At_Connect_Legal_you')}
									<br />
									{t('The_rental_dispute_lawyers_in_our_network')}
									<br />
									{t('With_strong_negotiation')}
								</>
							)}
			...
			<section id="legal-issues" className="legal-issues mobile-bg-color  mt-5 mb-5">
				<div className="container text-center">
					...
					<ul className="pt-3 class-add">
						<li>
							<Link href="#">{t('Eviction_disputes')} </Link>
						</li>
						<li>
							<Link href="#">{t('Rent_increase_disputes')}</Link>
						</li>
						<li>
							<Link href="#">{t('Security_deposit_disputes')}</Link>
						</li>
						<li>
							<Link href="#">{t('Lease_agreement_interpretation')}</Link>
						</li>
						<li>
							<Link href="#">{t('Maintenance_and_repair_issues')}</Link>
						</li>
						<li>
							<Link href="#">{t('Termination_of_lease_disagreements')}</Link>
						</li>
					</ul>
				</div>
			</section>
						...
						<div className="col-lg-7 needlawyer-text-motor">
							<div className="titleHow">
								...
								<h2 className="text-black-add-fig Discover-lawyer discover-text-fun">
									...
									<span className="green-medium-2"> {t('rental_dispute')}</span>
							...
							<div className="row mt-5 benefit-margin" style={{marginBottom: '65px'}}>
								<div className="col-lg-12">
									<div className="titleHow pt-lg-0">
										...
										{t('Rental_dispute_lawyers_excel')}
									</div>
								</div>
								<div className="col-lg-12">
									<div className="titleHow pt-lg-0">
										...
										<div className="text-start Discover-lawyer" />
										{t('Rental_dispute_lawyers_possess')}
									</div>
								</div>
								<div className="col-lg-12">
									<div className="titleHow pt-lg-0">
										...
										<div className="text-start Discover-lawyer" />
										{t('When_rental_disputes_escalate')}
									</div>
								</div>
								<div className="col-lg-12">
									<div className="titleHow pt-lg-0">
										...
										<div className="text-start Discover-lawyer" />
										{t('Rental_dispute_lawyers_assist')}
									</div>
								</div>
							</div>
						</div>
									...
									<div className="accordion mt-5" id="accordionExample">
										<div className="accordion-item">
											...
											<div
												...
												data-bs-parent="#accordionExample">
												<div className="accordion-body border-0 text-white">
													{t('A_rental_dispute_lawyer_specializes_in')}
												</div>
											</div>
										</div>
										<div className="accordion-item">
										...
										<div className="accordion-item">
											...
											<div
												...
												data-bs-parent="#accordionExample">
												<div className="accordion-body border-0 text-white">
													{t('If_you_face_an_unlawful_eviction')}
												</div>
											</div>
										</div>
										<div className="accordion-item">
