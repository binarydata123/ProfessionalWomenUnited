...
export const metadata: Metadata = {
	title: 'Choose Your Pricing Plan - Connect Legal',
	description: 'Select the best pricing plan for your needs on Connect Legal. Explore our options and get started with the plan that suits you.',
	alternates: {
