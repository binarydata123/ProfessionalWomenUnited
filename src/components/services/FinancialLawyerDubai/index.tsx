								...
								{isMobileView ? (
									<>
										{showFullText ? (
											...
											'A financial lawyer provides legal advice and representation on finance-related matters, including regulatory compliance, contract negotiation, mergers and acquisitions, and dispute resolution.'
										)}
										<br />
