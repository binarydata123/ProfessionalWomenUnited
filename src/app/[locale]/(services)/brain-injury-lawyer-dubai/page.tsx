...
export async function generateMetadata(): Promise<Metadata> {
	return {
		title: 'Brain Injury Lawyer in Dubai – Connect Legal',
		description:
			'Recover from traumatic injuries with a brain injury lawyer in Dubai. Connect Legal is here to help with expert legal advice.',
		alternates: {
