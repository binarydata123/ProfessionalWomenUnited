...
export async function generateMetadata(): Promise<Metadata> {
	return {
		title: 'Uber Accidents Lawyer in Dubai – Connect Legal',
		description:
			'Involved in a rideshare accident? Connect Legal can connect you with an Uber accidents lawyer in Dubai to handle your case.',
		alternates: {
