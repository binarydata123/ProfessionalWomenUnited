...
export async function generateMetadata(): Promise<Metadata> {
	return {
		title: 'Property Lawyer in Dubai – Connect Legal',
		description:
			'Deal with property issues confidently with a property lawyer in Dubai. Connect Legal is here to provide the support you need.',
		alternates: {
