...
export async function generateMetadata(): Promise<Metadata> {
	return {
		title: 'Bicycle Accident Lawyer in Dubai – Connect Legal',
		description:
			'Had a bicycle mishap? Connect Legal can help you find a bicycle accident lawyer in Dubai to advise you on the best legal action.',
		alternates: {
