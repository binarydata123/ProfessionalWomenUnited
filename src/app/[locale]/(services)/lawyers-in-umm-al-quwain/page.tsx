...
export async function generateMetadata(): Promise<Metadata> {
	return {
		title: 'Find the Best Lawyers in Umm Al Quwain | Connect Legal',
		description:
			'Connecting you with the best lawyers Umm Al Quwain has to offer, Connect Legal is your gateway to professional legal representation. Start your search now!',
		alternates: {
