...
export async function generateMetadata(): Promise<Metadata> {
	return {
		title: 'Marriage Lawyers in Dubai – Connect Legal',
		description:
			'Ensure your marriage aligns with local laws using a marriage lawyer in Dubai. Connect Legal can guide you through marital legal requirements.',
		alternates: {
