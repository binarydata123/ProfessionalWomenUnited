	...
	return (
		<>
			<div className="right-body pl-0 mt-5">
				<h4 className="font-xx-large social-link weight-semi-bold p-set-clas pt-3">Settings</h4>
			</div>
			...
			<div className="right-body pt-0">
				...
				<div className="row mb-5">
					<div className="col-sm-6">
						...
						<label className="font-small  weight-medium text-sonic-silver w-100 pb-2">New Password*</label>
						<div className="icon-fild">
							...
							/>
							<span
								className={`eye-icon  fafa_eye ${showNewPassword ? 'show' : ''}`}
						...
						<label className="font-small  weight-medium password-sonic-silver w-100 mt-4 pb-2">
							Re-type Password*
						</label>
						<div className="icon-fild">
							<input
							...
							/>
							<span
								className={`eye-icon  fafa_eye ${showConfirmPassword ? 'show' : ''}`}
					...
					<p className="font-small color-light mb-2 weight-medium pt-5">Privacy</p>
					<hr className="hr-line mt-0" />
					...
					<div className="mt-5">
						...
						<div className="row mt-4">
							<div className="col-sm-10 col-9">
								<p className="font-large social-link weight-semi-bold m-font-18">
