...
export default function BestLawyersFujairah() {
	...
	const t = useTranslations('bestLawyersFujairah');
					...
					<div className="row">
						<div className="col-lg-7">
							<h1 className="font-larger weight-bold green-medium-dark mobile-m-0">
								{t('Find_the_Best_Lawyers_in_Fujairah')}
							</h1>
						...
						<div className="col-lg-7 text-right order-lg-0 order-last">
							<div className="still" id="accordianSectionGreen">
								<h3 className="font-smaller weight-bold text-black-add-fig">
									...
									<span className="green-medium-2">{t('Lawyer_in_Fujairah')} </span>
								...
								<div className="accordion mt-4" id="setbotomspace">
									<div className="accordion-item">
										...
										<div
											...
											<div className="accordion-body border-0">{t('Lawyers_in_Fujairah')}</div>
										</div>
									</div>
									<div className="accordion-item">
										...
										<div
											...
											<div className="accordion-body border-0">
												{t('The_Best_Lawyers_in_Fujairah')}
											</div>
										</div>
									</div>
									<div className="accordion-item">
										...
										<div
											...
											data-bs-parent="#accordionExample">
											<div className="accordion-body border-0">
												{t('We_Prioritize_Your_Individual')}
											</div>
										</div>
									</div>
									<div className="accordion-item">
										...
										<div
											...
											data-bs-parent="#accordionExample">
											<div className="accordion-body border-0">
												{t('Open_and_Transparent_Communication')}
											</div>
										</div>
									</div>
									<div className="accordion-item">
										...
										<div
											...
											data-bs-parent="#accordionExample">
											<div className="accordion-body border-0">
												{t('Your_Satisfaction_is_Our_Top_Priority')}
											</div>
										</div>
									</div>
									<div className="accordion-item">
				...
				<div className="container">
					<div className="still">
						...
						<h3 className="font-xxx-large weight-bold text-black mt-3 discover-font">
							{t('Discover_the')} <span className="green-medium-2">{t('Top_Lawyers_in_Fujairah')}</span>
						</h3>
						...
						<div className="col-lg-7 needlawyer-text-motor">
							<div className="titleHow">
								...
								<h2 className="text-black-add-fig Discover-lawyer discover-text-fun">
									...
									<span className="green-medium-2"> {t('Fujairah')}</span> {t('Help_Me')}
								</h2>
								<div className="mt-4">
									<Link href={'/find-a-professional'}>
							...
							<div className="row mt-5 benefit-margin" style={{ marginBottom: '65px' }}>
								...
								<div className="col-lg-12">
									<div className="titleHow pt-lg-0">
										...
										<div className="text-start Discover-lawyer" />
										{t('Your_Rights_and_Interests_are')}
									</div>
								</div>
								<div className="col-lg-12">
									<div className="titleHow pt-lg-0">
								...
								<div className="col-lg-12">
									<div className="titleHow pt-lg-0">
										...
										<div className="text-start Discover-lawyer" />
										{t('In_Fujairahs_Legal_Landscape')}
									</div>
								</div>
							</div>
						</div>
										...
										<div className="accordion-item">
											<h2 className="accordion-header" id="headingOne">
												<button
													...
													{t('Can_I_Trust_the_Lawyers_Listed_on_Connect_Legal')}
												</button>
											</h2>
											<div
												id="collapseOne"
												...
												<div className="accordion-body border-0 text-white">
													{t('Absolutely_Connect_Legal_Takes')}
												</div>
											</div>
										</div>
										<div className="accordion-item">
											<h2 className="accordion-header" id="headingTwo1">
												<button
													...
													{t('How_Does_Connect_Legal_Prioritize_Client_Satisfaction')}
												</button>
											</h2>
											<div
												id="collapseTwo1"
												...
												data-bs-parent="#accordionExample">
												<div className="accordion-body border-0 text-white">
													{t('At_Connect_Legal_Client_Satisfaction')}
												</div>
											</div>
										</div>
										<div className="accordion-item">
											<h2 className="accordion-header" id="headingThree">
												<button
													...
													{t(
														'What_Sets_Connect_Legal_Apart_from_Other_Legal_Service_Providers_in_Fujairah'
													)}
												</button>
											</h2>
											<div
												...
												data-bs-parent="#accordionExample">
												<div className="accordion-body border-0 text-white">
													{t('Connect_Legal_Stands_Out_for_Its')}
												</div>
											</div>
										</div>
										<div className="accordion-item">
											<h2 className="accordion-header" id="headingFour">
												<button
													...
													{t(
														'What_Qualifications_and_Credentials_Should_I_Look_for_in_a_Lawyer_in_Fujairah'
													)}
												</button>
											</h2>
											<div
												...
												data-bs-parent="#accordionExample">
												<div className="accordion-body border-0 text-white">
													{t('When_Choosing_a_Lawyer_in_Fujairah')}
												</div>
											</div>
										</div>
										<div className="accordion-item">
											<h2 className="accordion-header" id="headingFive">
												<button
													...
													{t('Can_I_Represent_Myself_in_Legal_Proceedings_in_Fujairah')}
												</button>
											</h2>
											<div
												id="collapseFive"
												...
												data-bs-parent="#accordionExample">
												<div className="accordion-body border-0 text-white">
													{t('While_Its_Possible_to_Represent_Yourself')}
												</div>
											</div>
										</div>
										<div className="accordion-item">
											<h2 className="accordion-header" id="headingSix">
												<button
													...
													{t('How_Long_Does_it_Take_to_Resolve_a_Legal_Matter')}
												</button>
											</h2>
											<div
												id="collapseSix"
										...
										<div className="accordion-item">
											<h2 className="accordion-header" id="headingSeven">
												<button
													...
													{t(
														'What_are_the_benefits_of_hiring_a_lawyer_through_Connect_Legal_in_Fujairah'
													)}
												</button>
											</h2>
											<div
												...
												data-bs-parent="#accordionExample">
												<div className="accordion-body border-0 text-white">
													{t('By_hiring_a_lawyer_through_Connect_Legal')}
												</div>
											</div>
										</div>
										<div className="accordion-item">
											...
											<div
												...
												data-bs-parent="#accordionExample">
												<div className="accordion-body border-0 text-white">
													{t('Effective_communication_with_your')}
													<br />
													{t('You_want_to_maintain_an_open ')}
												</div>
											</div>
										</div>
									</div>
						...
						<div className="col-md-6">
							<div className="needlawyer-text pt-0">
								...
								<p>
									...
									firms in Fujairah and across the UAE, Today! or chat with a{' '}
