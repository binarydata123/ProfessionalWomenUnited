...
export const metadata: Metadata = {
	title: 'Legal Issues - Connect Legal',
	description: 'Explore legal issues on Connect Legal. Find information and resources on a variety of legal topics. Get guidance and support for your legal concerns.',
	alternates: {
