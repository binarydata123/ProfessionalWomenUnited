...
export async function generateMetadata(): Promise<Metadata> {
	return {
		title: 'Car Accident Lawyer in Dubai – Connect Legal',
		description:
			'Recover your losses from a traffic incident with a car accident lawyer in Dubai. Connect Legal provides the expert advice you need.',
		alternates: {
