					...
					<div className="row">
						<div className="col-lg-7">
							<h1 className="font-larger weight-bold green-medium-dark mobile-m-0">
								{t('Dispute_Resolution_Lawyer_Dubai')}
							</h1>
							<p className="weight-light social-link font-medium mt-4">
								{isMobileView ? (
									<>
										{showFullText ? (
											<>{t('A_dispute_lawyer_specializes')}</>
										) : (
											`${t('A_dispute_lawyer_specializes')}`
										)}
										<br />
						...
						<div className="col-lg-5 text-right tab-center">
							<Image
								src="/images/legal-service/DisputeResolutionLawyer.jpg"
								alt="AdobeStock"
					...
					<div className="row mt-md-5 align-items-end">
						<div className="col-lg-4 col-md-12">
							<h2 className="font-smaller weight-bold text-white">
								<span className="green-med">{t('Dispute_Resolution')}</span>{' '}
								<span className="green-med-col">{t('Success_Rate')}</span>
							</h2>
							<p className="weight-light font-medium text-white mt-3">{t('A_study_conducted_by_the')}</p>
						</div>
											...
											<div className="accordion-item">
												...
												<div
													...
													<div className="accordion-body border-0 text-white">
														{t('One_of_the_most_common')}
														<br />
														{t('The_mediator_facilitates_communication')}
													</div>
												</div>
											</div>
											<div className="accordion-item">
												...
												<div
													...
													data-bs-parent="#accordionExample">
													<div className="accordion-body border-0 text-white">
														{t('Arbitration_is_a_more_formal')}
														<br />
														{t('These_arbitrators_listen')}
													</div>
												</div>
											</div>
											<div className="accordion-item">
												...
												<div
													...
													<div className="accordion-body border-0 text-white">
														{t('Litigation')}
														<br />
														{t('Litigation_is_the_traditional')}
														<br />
														{t('If_your_looking_for')}
													</div>
												</div>
											</div>
										</div>
					...
					<div className="row sectionGap flex-wrap-none">
						<div className="col-lg-12 col-xl-5 col-md-12">
							<h2 className="font-smaller text-black  weight-bold mb-4">
								{t('Main_Steps_of_Dispute_Resolution')}
								<span className="green-medium-2">{t('Dispute_Resolution')}</span>
							</h2>
							<Image
							...
							<div className="accordion mt-5 margin-top-1" id="accordionExample">
								<div className="accordion-item">
									...
									<div
										...
										<div className="accordion-body border-0">
											{t('The_first_step_in_dispute_resolution')}
										</div>
									</div>
								</div>
								<div className="accordion-item">
									...
									<div
										...
										data-bs-parent="#accordionExample">
										<div className="accordion-body border-0">
											{t('Once_the_issue_is_identified_the')}
										</div>
									</div>
								</div>
								<div className="accordion-item">
								...
								<div className="accordion-item">
									...
									<div
										...
										data-bs-parent="#accordionExample">
										<div className="accordion-body border-0">
											{t('Once_options_are_identified_negotiation')}
										</div>
									</div>
								</div>
								<div className="accordion-item">
									...
									<div
										...
										data-bs-parent="#accordionExample">
										<div className="accordion-body border-0">
											{t('Once_a_resolution_is_reached_the')}
										</div>
									</div>
								</div>
							</div>
								...
								<div className="accordion mt-4" id="setbotomspace">
									<div className="accordion-item">
										<h2 className="accordion-header" id="headingEight">
											<button
												...
												{t('Access_to_Specialized_Expertise')}
											</button>
										</h2>
										<div
											id="collapseEight"
											...
											data-bs-parent="#accordionExample">
											<div className="accordion-body border-0">
												{t('Connect_Legal_provides_access_to_a_network')}
											</div>
										</div>
									</div>
									<div className="accordion-item">
										...
										<div
											...
											data-bs-parent="#accordionExample">
											<div className="accordion-body border-0">
												{t('Through_Connect_Legal_you_receive')}
											</div>
										</div>
									</div>
									<div className="accordion-item">
									...
									<div className="accordion-item">
										...
										<div
											...
											data-bs-parent="#accordionExample">
											<div className="accordion-body border-0">
												{t('Clients_using_Connect_Legal_can')}
											</div>
										</div>
									</div>
									<div className="accordion-item">
										...
										<div
											...
											data-bs-parent="#accordionExample">
											<div className="accordion-body border-0">
												{t('The_lawyers_on_our_platform_prioritize')}
											</div>
										</div>
									</div>
									<div className="accordion-item">
										...
										<div
											...
											data-bs-parent="#accordionExample">
											<div className="accordion-body border-0">
												{t('Connect_Legal_connects_clients_with')}
												<br />
												{t('This_specialized_knowledge_enables')}
											</div>
										</div>
									</div>
								</div>
				...
				<div className="container">
					<div className="still">
						...
						<h3 className="font-xxx-large weight-bold text-black mt-3 discover-font">
							{t('Discover_the')}{' '}
							<span className="green-medium-2">{t('Top_Dispute_Resolution_Lawyers_in_Dubai')}</span>
						</h3>
			...
			<section id="legal-issues" className="legal-issues mobile-bg-color  mt-5 mb-5">
				<div className="container text-center">
					...
					<p className="font-medium weight-medium social-link set-text-padding color-frequent set-top-mrgin-mbl">
						{t('Clients_usually_want_to_get_knowledgeable_legal')}
						<br />
						{t('Select_the_legal_issue')}
					</p>
					<ul className="pt-3 class-add">
						<li>
							<Link href="#">{t('Business_disputes')}</Link>
						</li>
						<li>
							<Link href="#">{t('Family_conflicts')}</Link>
						</li>
						<li>
							<Link href="#">{t('Contract_disagreements')}</Link>
						</li>
						<li>
							<Link href="#">{t('Employment_issues')}</Link>
						</li>
						<li>
							<Link href="#">{t('Property_disputes')}</Link>
						</li>
					</ul>
				</div>
			</section>
							...
							<div className="row mt-5 benefit-margin" style={{marginBottom: '65px'}}>
								<div className="col-lg-12">
									<div className="titleHow pt-lg-0">
										...
										{t('Dispute_resolution_lawyers_play_a_crucial_role')}
									</div>
								</div>
								<div className="col-lg-12">
									<div className="titleHow pt-lg-0">
										...
										<div className="text-start Discover-lawyer" />
										{t('Dispute_resolution_lawyers_provide')}
									</div>
								</div>
								<div className="col-lg-12">
									<div className="titleHow pt-lg-0">
										...
										<div className="text-start Discover-lawyer" />
										{t('In_cases_where_negotiation_and')}
										<br />
										{t('Lawyers_work_around_complex')}
									</div>
								</div>
								<div className="col-lg-12">
									<div className="titleHow pt-lg-0">
										...
										<div className="text-start Discover-lawyer" />
										{t('Dispute_resolution_lawyers')}
										<br />
										{t('Dispute_resolution_lawyers__provide')}
									</div>
								</div>
							</div>
						</div>
										...
										<div className="accordion-item">
											<h2 className="accordion-header" id="headingOne">
												<button
													...
													aria-expanded="true"
													aria-controls="collapseOne">
													{t('How_long_does_dispute_resolution_typically_take')}
												</button>
											</h2>
											<div
												id="collapseOne"
												...
												data-bs-parent="#accordionExample">
												<div className="accordion-body border-0 text-white">
													{t('Dispute_resolution_timelines_vary_depending')}
												</div>
											</div>
										</div>
										<div className="accordion-item">
											<h2 className="accordion-header" id="headingTwo1">
												<button
													...
													aria-expanded="true"
													aria-controls="collapseTwo1">
													{t('What_are_the_advantages_of_mediation_over_litigation')}
												</button>
											</h2>
											<div
												id="collapseTwo1"
												...
												data-bs-parent="#accordionExample">
												<div className="accordion-body border-0 text-white">
													{t('Mediation_offers_several_advantages_over')}
												</div>
											</div>
										</div>
										<div className="accordion-item">
											<h2 className="accordion-header" id="headingThree">
												<button
													...
													aria-expanded="true"
													aria-controls="collapseThree">
													{t('Can_I_still_hire_a_lawyer_if_I_want_to_try_mediation_first')}
												</button>
											</h2>
											<div
												id="collapseThree"
												...
												data-bs-parent="#accordionExample">
												<div className="accordion-body border-0 text-white">
													{t('Yes_you_can_still_hire_a_lawyer_to_represent')}
												</div>
											</div>
										</div>
										<div className="accordion-item">
											<h2 className="accordion-header" id="headingFour">
												<button
													...
													aria-expanded="true"
													aria-controls="collapseFour">
													{t('What_types_of_disputes_can_be_resolved_through_arbitration')}
												</button>
											</h2>
											<div
												id="collapseFour"
												...
												data-bs-parent="#accordionExample">
												<div className="accordion-body border-0 text-white">
													{t('Arbitration_can_resolve_various_types_of_disputes')}
												</div>
											</div>
										</div>
										<div className="accordion-item">
											<h2 className="accordion-header" id="headingFive">
												<button
													...
													aria-expanded="true"
													aria-controls="collapseFive">
													{t('How_do_I_know_if_litigation_is_the_best_option_for_my_dispute')}
												</button>
											</h2>
											<div
												id="collapseFive"
												...
												data-bs-parent="#accordionExample">
												<div className="accordion-body border-0 text-white">
													{t('The_decision_to_pursue_litigation_depends')}
												</div>
											</div>
										</div>
										<div className="accordion-item">
											<h2 className="accordion-header" id="headingSix">
												<button
													...
													{t('Can_dispute_resolution_be_legally_binding')}
												</button>
											</h2>
											<div
												id="collapseSix"
												...
												data-bs-parent="#accordionExample">
												<div className="accordion-body border-0 text-white">
													{t('Yes_depending_on_the_chosen_method')}
												</div>
											</div>
										</div>
										<div className="accordion-item">
											<h2 className="accordion-header" id="headingSix">
												<button
													...
													{t('What_are_the_costs_associated_with_dispute_resolution')}
												</button>
											</h2>
											<div
												id="collapseSeven"
												...
												data-bs-parent="#accordionExample">
												<div className="accordion-body border-0 text-white">
													{t('The_costs_of_dispute_resolution')}
												</div>
											</div>
										</div>
										<div className="accordion-item">
											<h2 className="accordion-header" id="headingSix">
												<button
													...
													aria-expanded="true"
													aria-controls="collapseEight">
													{t('Is_dispute_resolution_confidential')}
												</button>
											</h2>
											<div
												id="collapseEight"
												...
												data-bs-parent="#accordionExample">
												<div className="accordion-body border-0 text-white">
													{t('Confidentiality_is_key_to_many')}
												</div>
											</div>
										</div>
									</div>
