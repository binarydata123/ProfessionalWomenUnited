...
export default function PropertyLawyer() {
	...
	const t = useTranslations('propertyLawyer');
				...
				<div className="container">
					...
					<div className="row">
								...
								{isMobileView ? (
									<>
										{showFullText ? (
											...
											'A property lawyer handles legal matters related to real estate, such as buying, selling, leasing, or resolving disputes. They advise on property law contracts and make sure transactions are legally sound. Professional Women United has the best property lawyers in Dubai who provide personalized assistance and guide clients through the process with expertise. Our attorneys offer clear, accessible professional services, helping you deal with property law efficiently and confidently.'
										)}
										<br />
						...
						<div className="col-lg-5 text-right tab-center">
							<Image
								src="/images/car/motorcycle.jpeg"
								alt="AdobeStock"
					...
					<div className="row mt-md-5 align-items-end">
						<div className="col-lg-4 col-md-12">
							<h2 className="font-smaller weight-bold text-white">
								<span className="green-med">{t('Key_Insights_for_Investors')}</span>{' '}
								<span className="green-med-col">{t('In_Dubai')}</span>
							</h2>
							<p className="weight-light font-medium text-white mt-3">{t('Investing_in_Dubai_real')}</p>
						</div>
							...
							<div className="row align-items-lg-center set-pad-stat set-mob-pad">
								...
								<div className="col-lg-11 col-9 p-lg-0">
									<p
										...
										{t('percent_increase_in_short-term')}
									</p>
								</div>
							</div>
										...
										<div className="accordion mt-5" id="accordionExample">
											...
											<div className="accordion-item">
												...
												<div
													...
													data-bs-parent="#accordionExample">
													<div className="accordion-body border-0 text-white">
														{t('Foreign_investors_have')}
														<br />
														<br /> {t('If_you_considering ')}
													</div>
												</div>
											</div>
										</div>
					...
					<div className="row sectionGap flex-wrap-none">
						<div className="col-lg-12 col-xl-5 col-md-12">
							<h2 className="font-smaller text-black  weight-bold mb-4">
								...
								<span className="green-medium-2"> {t('Methods')}</span>
							</h2>
							<Image
								...
								<div className="accordion-item">
									...
									<div
										...
										<div className="accordion-body border-0">
											{t('This_method_involves_comparing')}
										</div>
									</div>
								</div>
								<div className="accordion-item">
								...
								<div className="accordion-item">
									<h2 className="accordion-header" id="headingThree">
										<button
											...
											aria-expanded="false"
											aria-controls="collapseThree">
											{t('Income_Capitalization_Approach')}
										</button>
									</h2>
									<div
										id="collapseThree"
										...
										data-bs-parent="#accordionExample">
										<div className="accordion-body border-0">
											{t('The_income_approach_values_a')}
										</div>
									</div>
								</div>
								<div className="accordion-item">
									...
									<div
										...
										aria-labelledby="headingThree"
										data-bs-parent="#accordionExample">
										<div className="accordion-body border-0">{t('This_method_calculates')}</div>
									</div>
								</div>
								<div className="accordion-item">
									...
									<div
										...
										data-bs-parent="#accordionExample">
										<div className="accordion-body border-0">
											{t('Automated_Valuation_Models_AVMs')}
										</div>
									</div>
								</div>
							</div>
								...
								<div className="accordion mt-4" id="setbotomspace">
									<div className="accordion-item">
										<h2 className="accordion-header" id="headingEight">
											<button
												...
												{t('Expertise_in_Local_Property_Laws')}
											</button>
										</h2>
										<div
											id="collapseEight"
											...
											data-bs-parent="#accordionExample">
											<div className="accordion-body border-0">{t('Connect_Legal_property')}</div>
										</div>
									</div>
									<div className="accordion-item">
										...
										<div
											...
											data-bs-parent="#accordionExample">
											<div className="accordion-body border-0">
												{t('Our_network_of_lawyers_offers')}
											</div>
										</div>
									</div>
									<div className="accordion-item">
									...
									<div className="accordion-item">
										...
										<div
											...
											data-bs-parent="#accordionExample">
											<div className="accordion-body border-0">
												{t('Connect_Legal_property_lawyers')}
											</div>
										</div>
									</div>
									<div className="accordion-item">
										...
										<div
											...
											data-bs-parent="#accordionExample">
											<div className="accordion-body border-0">
												{t('Connect_Legal_property_lawyers_in_Dubai')}
											</div>
										</div>
									</div>
									<div className="accordion-item">
				...
				<div className="container">
					<div className="still">
						...
						<h3 className="font-xxx-large weight-bold text-black mt-3 discover-font">
							{t('Discover_the')}{' '}
							<span className="green-medium-2">{t('Top_Dubai_Property_Lawyers')}</span>
						</h3>
			...
			<section id="legal-issues" className="legal-issues mobile-bg-color  mt-5 mb-5">
				<div className="container text-center">
					...
					<p className="font-medium weight-medium social-link set-text-padding color-frequent set-top-mrgin-mbl">
						{t('When_looking_for_legal')}
						<br />
						{t('Select_the_legal_issue')}
					</p>
					<ul className="pt-3 class-add">
						<li>
							<Link href="#">{t('Property_purchases_and_sales')}</Link>
						</li>
						<li>
							<Link href="#">{t('Rental_agreements_and_disputes')}</Link>
						</li>
						<li>
							<Link href="#">{t('Real_estate_investments')}</Link>
						</li>
						<li>
							<Link href="#">{t('Landlord-tenant_law')}</Link>
						</li>
						<li>
							<Link href="#">{t('Property_development_and_construction_laws')}</Link>
						</li>
						<li>
							<Link href="#">{t('Property_registration_and_title_transfers')}</Link>
						</li>
					</ul>
				</div>
			</section>
						...
						<div className="col-lg-7 needlawyer-text-motor">
							<div className="titleHow">
								...
								<h2 className="text-black-add-fig Discover-lawyer discover-text-fun">
									...
									<span className="green-medium-2"> {t('Property')}</span>
										...
										<div className="accordion-item">
											<h2 className="accordion-header" id="headingOne">
												<button
													...
													aria-expanded="true"
													aria-controls="collapseOne">
													{t('What_does_a_property_lawyer_in_Dubai_do')}
												</button>
											</h2>
											<div
												id="collapseOne"
										...
										<div className="accordion-item">
											<h2 className="accordion-header" id="headingTwo1">
												<button
													...
													aria-expanded="true"
													aria-controls="collapseTwo1">
													{t('When_should_I_consult_a_property_lawyer')}
												</button>
											</h2>
											<div
												id="collapseTwo1"
										...
										<div className="accordion-item">
											<h2 className="accordion-header" id="headingThree">
												<button
													...
													aria-expanded="true"
													aria-controls="collapseThree">
													{t('How_can_a_property_lawyer_help_with_a_property_purchase')}
												</button>
											</h2>
											<div
												id="collapseThree"
										...
										<div className="accordion-item">
											<h2 className="accordion-header" id="headingFour">
												<button
													...
													aria-controls="collapseFour">
													{t(
														'What_types_of_property_disputes_can_a_property_lawyer_assist_with'
													)}
												</button>
											</h2>
											<div
										...
										<div className="accordion-item">
											<h2 className="accordion-header" id="headingFive">
												<button
													...
													aria-expanded="true"
													aria-controls="collapseFive">
													{t('How_do_property_lawyers_help_with_leasing_agreements')}
												</button>
											</h2>
											<div
												id="collapseFive"
												...
												data-bs-parent="#accordionExample">
												<div className="accordion-body border-0 text-white">
													{t('Property_lawyers_can_help_with')}
												</div>
											</div>
										</div>
										<div className="accordion-item">
											<h2 className="accordion-header" id="headingSix">
												<button
													...
													{t(
														'What_should_I_bring_to_my_first_meeting_with_a_property_lawyer'
													)}
													lawyer?
												</button>
											</h2>
											<div
												...
												data-bs-parent="#accordionExample">
												<div className="accordion-body border-0 text-white">
													{t('Bring_any_relevant_documents')}
												</div>
											</div>
										</div>
									</div>
