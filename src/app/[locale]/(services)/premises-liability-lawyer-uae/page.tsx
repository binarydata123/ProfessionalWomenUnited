...
export async function generateMetadata(): Promise<Metadata> {
	return {
		...
		description:
			'Address premises liability issues with a premises liability lawyer in UAE. Professional Women United can help you navigate your legal rights and options.',
		alternates: {
