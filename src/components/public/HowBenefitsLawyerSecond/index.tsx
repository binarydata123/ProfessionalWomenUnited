...
export default function HowBenefitsLawyerSecond({ data }: GotBenefitsProps) {
		...
		<>
			<section className="howBenefitsLawyer">
				<div className="container">
					<div className="row">
						<div className="col-lg-4 order-lg-0 order-last mt-lg-0 mt-5">
							<img src="/images/car/Benefits-pic.jpg" alt="Benefits-pic" />
						</div>
						<div className="col-lg-8 needlawyer-text">
							<div className="titleHow">
								<div className="">
									...
									<h2 className="text-start Discover-lawyer">
										...
										<span className=""> car accident-related</span> legal matters?
									</h2>
								</div>
										...
										<div className="titleHow pt-lg-0">
											<div className=" pt-4">
												<h4 className="text-start">
													{capitalizeFirstLetterOfEachWord(benefit.title)}
												</h4>
											</div>
											<div
												className="text-start Discover-lawyer"
