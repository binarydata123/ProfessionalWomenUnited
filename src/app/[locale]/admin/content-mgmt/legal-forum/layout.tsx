...
export default function LegalForumLayout({ children }: { children: React.ReactNode }) {
			...
			<div className="nav-tab use-lawyer p-set p-0 border-0">
				<ul className="border-bottom">
					<li className={pathname === '/admin/content-mgmt/legal-forum' ? 'active' : ''}>
						<Link aria-current="page" href="/admin/content-mgmt/legal-forum">
							Live posts
						</Link>
					</li>
					<li className={pathname.includes('/admin/content-mgmt/legal-forum/approvals') ? 'active' : ''}>
						<Link href="/admin/content-mgmt/legal-forum/approvals">Approvals</Link>
					</li>
					<li
						className={
							pathname.includes('/admin/content-mgmt/legal-forum/lawyer-contributions') ? 'active' : ''
						}
					>
						<Link href="/admin/content-mgmt/legal-forum/lawyer-contributions">Lawyer Contributions</Link>
					</li>
				</ul>
			</div>
