...
export default function InheritanceLawyerUae() {
	...
	const t = useTranslations("inheritanceLawyer")
				...
				<div className="container">
					...
					<div className="row">
						<div className="col-lg-7">
							<h1 className="font-larger weight-bold green-medium-dark mobile-m-0">{t('Inheritance_Lawyer_in_UAE')}</h1>
								...
								{isMobileView ? (
									<>
										{showFullText ? (
											...
											'An inheritance lawyer specializes in matters related to wills, trusts and estate planning, ensuring the proper distribution of assets.'
										)}
										<br />
						...
						<div className="col-lg-5 text-right tab-center">
							<Image src="/images/legal-service/inheritance_lawyer.jpeg" alt="AdobeStock" className="effect show-hide" width={516} height={344} style={{ borderRadius: '8px' }} />
						</div>
					</div>
				</div>
			</section>
						...
						<div className="col-lg-12 col-md-12">
							<div className="content-wrapper">
								<h2 className="font-smaller weight-bold text-white">
									<span className="green-med">{t('UAE_Inheritance')}</span>
									...
									<div className="accordion-item">
										<h2 className="accordion-header" id="headingOne">
											<button
												...
												{t('UAE_Inheritance_Law_for_Muslims')}
											</button>
										</h2>
										<div
											id="collapseOne"
								...
								<div className="accordion-item">
									<h2 className="accordion-header" id="headingSix">
										<button
											...
											{t('Remaining_Property_Distribution')}
										</button>
									</h2>
									<div
										id="collapseSix"
									...
									<div className="accordion-item">
										<h2 className="accordion-header" id="headingEight">
											<button
												...
												{t('Expertise_in_Inheritance_Law')}
											</button>
										</h2>
										<div
											id="collapseEight"
			...
			<section id="legal-issues" className="legal-issues mobile-bg-color  mt-5 mb-5">
				<div className="container text-center">
					...
					<ul className="pt-3 class-add">
						<li>
							<Link href="#">{t('Inheritance_dispute_resolution')}</Link>
						</li>
						<li>
							<Link href="#">{t('Estate_planning_and_will_drafting')}</Link>
						</li>
						<li>
							<Link href="#">{t('Probate_proceedings')}</Link>
						</li>
						<li>
							<Link href="#">{t('Distribution_of_assets_among_heirs')}</Link>
						</li>
						<li>
							<Link href="#">{t('Legal_rights_of_beneficiaries')}</Link>
						</li>
					</ul>
				</div>
			</section>
								...
								<div className="col-lg-12">
									...
									<div className="col-lg-12">
										<div className="titleHow pt-lg-0">
											...
											<div className="text-start Discover-lawyer" />
											{t('Inheritance_lawyers_specializing')}
										</div>
									</div>
									<div className="col-lg-12">
										<div className="titleHow pt-lg-0">
										...
										<div className="accordion-item">
											<h2 className="accordion-header" id="headingOne">
												<button
													...
													aria-expanded="true"
													aria-controls="collapseOne">
													{t('What_is_the_role_of_an_inheritance_lawyer')}
												</button>
											</h2>
											<div
												id="collapseOne"
										...
										<div className="accordion-item">
											<h2 className="accordion-header" id="headingTwo1">
												<button
													...
													aria-expanded="true"
													aria-controls="collapseTwo1">
													{t('When_should_I_hire_an')}{t('inheritance_lawyer')}
												</button>
											</h2>
											<div
												id="collapseTwo1"
