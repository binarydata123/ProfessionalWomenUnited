...
export const cancelPlanSubscription = async data => {
	return new Promise((resolve, reject) => {
		const req = axios.request(process.env.NEXT_PUBLIC_API_URL + '/professional/cancel-subscription', {
			method: 'post',
			headers: {
				Accept: 'application/json',
				'Content-Type': 'application/json',
...
export const checkEmailVerfiyOTP = async data => {
	return new Promise((resolve, reject) => {
		const req = axios.request(process.env.NEXT_PUBLIC_API_URL + '/check-email-verify-otp', {
			method: 'post',
			headers: {
				Accept: 'application/json'
				// Authorization: 'Bearer ' + getToken()
...
export const resendEmailVerifyOtp = async data => {
	return new Promise((resolve, reject) => {
		const req = axios.request(process.env.NEXT_PUBLIC_API_URL + '/resend-email-verify-otp', {
			method: 'post',
			headers: {
				Accept: 'application/json'
				// Authorization: 'Bearer ' + getToken()
...
export const updatetwofactorSettings = async (user_id, two_factor_enabled) => {
	return new Promise((resolve, reject) => {
		const req = axios.request(`${process.env.NEXT_PUBLIC_API_URL}/professional/update-two-factor-settings`, {
			method: 'post',
			headers: {
				Accept: 'application/json',
				Authorization: 'Bearer ' + getToken(),
